...
- Win: Productklarheit v1 ist belegt.
  Why it matters: Schulwerkstatt und LeseWerk haben eine klarere Verbindung und weniger Startreibung.
  Proof: `/Users/zondrius/hermes-workspace/reports/productklarheit-v1-ceo-synthesis-2026-05-31.md`

## Nicht anfassen
- Item: Keine neuen großen Missionen, keine Auto-Archivierung, keine Installs/Commits/Pushes.
...
## Memory Kandidaten
- Candidate: Decision Inbox Regeln nur nach Review dauerhaft speichern.
  Category: stable-rule
  Recommendation: candidate
  Source: `/Users/zondrius/hermes-workspace/reports/decision-inbox/decision-inbox-2026-05-28.md`

- Candidate: Momentum Cockpit Status bleibt Projektstand, nicht Langzeit-Memory.
...
## Belege
- `/Users/zondrius/hermes-workspace/reports/decision-inbox/decision-inbox-2026-05-28.md` (decision-inbox)
