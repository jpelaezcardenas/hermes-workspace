# Questionnaire Skeleton v1 — Technical Due Diligence

**Document ID:** RB-QS-01-v1.0
**Codename:** DEEP
**Category:** Vendor Assessment Questionnaire
**Buyer type:** Architecture, CTO, platform engineering, and technical risk teams
**Primary intent:** Deep technical due diligence questionnaire for platform capability and operational fitness
**Default response model:** Structured vendor response with explicit evidence requests
**Tailoring variables:** deployment model, blockchain stack, integration estate, security posture, target scale
...
### 3.1 Core Question Domains (100-130 questions)
- Write about: architecture, APIs, workflows, identity, compliance controls, custody alignment, deployment, observability, resilience, performance, implementation, and support readiness
...
- Aim for 10-12 domains with 8-14 questions each
- Use this skeleton when the buyer needs technical confidence before contract or pilot approval
- Include question families that map cleanly to architecture, integration, operations, deployment, and performance evidence
