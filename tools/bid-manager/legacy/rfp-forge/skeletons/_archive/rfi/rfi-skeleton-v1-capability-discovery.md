# RFI Skeleton v1 — General Digital Asset Capability Discovery

**Document ID:** RB-RFI-01-v1.0
**Codename:** SCOUT
**Category:** RFI
**Buyer type:** Bank, market infrastructure provider, public authority, or large enterprise
**Primary intent:** Information gathering on platform breadth, maturity, and operating model
**Default response model:** Structured vendor response with explicit evidence requests
**Tailoring variables:** asset classes, geographies, deployment preference, integration maturity, risk appetite
...
### 3.1 Core Capability Areas (12-16 topic blocks)
- Write about: broad platform capabilities for issuance, servicing, compliance, integrations, custody alignment, reporting, and operating model maturity
...
- Keep breadth high and depth moderate
- Use this skeleton when the buyer is still mapping the market and is not ready to prescribe exact solution requirements
- Add optional sections for reference use cases and product roadmap orientation only if explicitly needed
