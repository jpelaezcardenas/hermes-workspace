# RFI Skeleton v4 — Sukuk and Islamic Finance Tokenization Capability Assessment

**Document ID:** RB-RFI-04-v1.0
**Codename:** SUKUK
**Category:** RFI
**Buyer type:** Islamic bank, sovereign issuer, Islamic finance authority, or regional market operator
**Primary intent:** Information gathering focused on sukuk structuring support, Sharia governance considerations, and lifecycle controls
**Default response model:** Structured vendor response with explicit evidence requests
**Tailoring variables:** sukuk structure type, jurisdiction, Sharia board expectations, settlement model, investor base
...
- Write about: capabilities relevant to sukuk and Islamic-finance-aligned digital asset issuance, including asset linkage, cash flow treatment, governance workflow, compliance evidence, servicing, and reporting
...
- Require the buyer document to distinguish between platform capability and external Sharia/legal validation responsibilities
- Ask vendors to explain how workflows can support issuer, trustee, SPV, paying agent, and investor role separation where relevant
- Include appendices for sukuk structure assumptions, glossary, and required disclosure forms
