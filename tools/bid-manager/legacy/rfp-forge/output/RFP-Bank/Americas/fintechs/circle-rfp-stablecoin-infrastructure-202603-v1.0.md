...
| Document Reference | CIRCLE-RFP-202603-06 |
| Document Type | RFP |
...
| Workstream 2 | Configuration of the platform for stablecoin infrastructure for institutional treasury and settlement, including product templates, token or asset models, workflow approvals, entitlement structures, reporting schemas, data retention rules and control checkpoints. |
...
| FR-10 | Support phased rollout by entity, geography, participant segment, product or workflow while preserving shared control patterns for stablecoin infrastructure for institutional treasury and settlement. | Mandatory | Narrative + evidence | Rollout plan / tenancy model |
...
| FR-13 | Support integration patterns specific to the buyer environment, including USDC reserve, mint/burn workflows, treasury and attestation processes, cross-chain infrastructure, compliance screening and partner APIs. | Mandatory | Narrative + evidence | Target-state integration blueprint |
...
|---|---|---|
| Functional fit and workflow coverage | 22% | Alignment to the target operating model for stablecoin infrastructure for institutional treasury and settlement and realism of end-to-end lifecycle coverage |
...
For Circle, respondents should assume the institution will require a formal governance pack covering scope, controls, stakeholders, escalation paths, evidentiary outputs, operational ownership, release checkpoints, model/rules governance and board- or committee-level reporting before any production release. That pack must be capable of supporting audit and management review over time.

### 8.7 Integration inventory template
| Area | Illustrative scope |
|---|---|
| Internal systems | USDC reserve, mint/burn workflows, treasury and attestation processes, cross-chain infrastructure, compliance screening and partner APIs. |
