...
| Document Reference | BREX-RFP-202603-10 |
| Document Type | RFP |
...
| Workstream 2 | Configuration of the platform for tokenized treasury management for corporate cash users, including product templates, token or asset models, workflow approvals, entitlement structures, reporting schemas, data retention rules and control checkpoints. |
...
| FR-10 | Support phased rollout by entity, geography, participant segment, product or workflow while preserving shared control patterns for tokenized treasury management for corporate cash users. | Mandatory | Narrative + evidence | Rollout plan / tenancy model |
...
| FR-13 | Support integration patterns specific to the buyer environment, including treasury management, ERP integrations, card / spend systems, banking partners and enterprise workflow automation. | Mandatory | Narrative + evidence | Target-state integration blueprint |
...
|---|---|---|
| Functional fit and workflow coverage | 22% | Alignment to the target operating model for tokenized treasury management for corporate cash users and realism of end-to-end lifecycle coverage |
...
The following scenarios are intended to test whether the proposed platform can keep Brex's control environment intact while supporting tokenized treasury management for corporate cash users. Respondents shall describe native product behaviour, configuration points, integration dependencies, operational ownership, evidence outputs and fallback procedures for each scenario.
...
For avoidance of doubt, Brex will treat unanswered delivery-risk questions as a material weakness even where the product appears functionally strong. The bidder should therefore identify non-standard assumptions, unresolved third-party dependencies, minimum-volume thresholds, jurisdictional constraints, roadmap items, implementation accelerators that require buyer resources, and any feature areas where manual controls remain necessary for tokenized treasury management for corporate cash users. This clarification section should also state what the buyer must provide to keep timeline, budget and control outcomes realistic.
