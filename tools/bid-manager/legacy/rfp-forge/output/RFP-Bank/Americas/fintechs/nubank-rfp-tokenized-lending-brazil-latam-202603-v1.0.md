...
| Document Reference | NUBANK-RFP-202603-04 |
| Document Type | RFP |
...
| Workstream 2 | Configuration of the platform for tokenized lending origination and servicing across Brazil/LatAm corridors, including product templates, token or asset models, workflow approvals, entitlement structures, reporting schemas, data retention rules and control checkpoints. |
...
| FR-10 | Support phased rollout by entity, geography, participant segment, product or workflow while preserving shared control patterns for tokenized lending origination and servicing across Brazil/LatAm corridors. | Mandatory | Narrative + evidence | Rollout plan / tenancy model |
...
| FR-13 | Support integration patterns specific to the buyer environment, including Nu app ecosystem, lending and treasury systems, PIX and regional payments, AML/KYC controls and data platforms. | Mandatory | Narrative + evidence | Target-state integration blueprint |
| FR-14 | Provide configurable controls for the regulatory perimeter relevant to Brazil, including recordkeeping, privacy, AML/sanctions checkpoints, outsourcing evidence and supervisory-ready reporting. | Mandatory | Narrative + evidence | Jurisdictional control matrix |
...
| RC-07 | Detail support for jurisdiction-specific obligations applicable in Brazil, including evidence production and buyer-operated policy controls. | Mandatory |
...
|---|---|---|
| Functional fit and workflow coverage | 22% | Alignment to the target operating model for tokenized lending origination and servicing across Brazil/LatAm corridors and realism of end-to-end lifecycle coverage |
...
For Nubank, respondents should assume the institution will require a formal governance pack covering scope, controls, stakeholders, escalation paths, evidentiary outputs, operational ownership, release checkpoints, model/rules governance and board- or committee-level reporting before any production release. That pack must be capable of supporting audit and management review over time.

### 8.7 Integration inventory template
| Area | Illustrative scope |
|---|---|
| Internal systems | Nu app ecosystem, lending and treasury systems, PIX and regional payments, AML/KYC controls and data platforms. |
