# Itaú Unibanco — Request for Proposal
...
| Document Reference | ITAU-UNIBANC-RFP-202603-10 |
| Document Type | RFP |
...
| Workstream 2 | Configuration of the platform for tokenized fixed income issuance and servicing in Brazil, including product templates, token or asset models, workflow approvals, entitlement structures, reporting schemas, data retention rules and control checkpoints. |
...
| FR-10 | Support phased rollout by entity, geography, participant segment, product or workflow while preserving shared control patterns for tokenized fixed income issuance and servicing in Brazil. | Mandatory | Narrative + evidence | Rollout plan / tenancy model |
...
| FR-13 | Support integration patterns specific to the buyer environment, including treasury and fixed-income issuance systems, custody and registrar interfaces, client portals, PIX/settlement rails, and enterprise risk/security tooling. | Mandatory | Narrative + evidence | Target-state integration blueprint |
...
|---|---|---|
| Functional fit and workflow coverage | 22% | Alignment to the target operating model for tokenized fixed income issuance and servicing in Brazil and realism of end-to-end lifecycle coverage |
...
For Itaú Unibanco, respondents should assume the institution will require a formal governance pack covering scope, controls, stakeholders, escalation paths, evidentiary outputs, operational ownership, release checkpoints, model/rules governance and board- or committee-level reporting before any production release. That pack must be capable of supporting audit and management review over time.

### 8.7 Integration inventory template
| Area | Illustrative scope |
|---|---|
| Internal systems | treasury and fixed-income issuance systems, custody and registrar interfaces, client portals, PIX/settlement rails, and enterprise risk/security tooling. |
