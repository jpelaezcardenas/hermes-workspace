# BTG Pactual — Request for Proposal
...
| Document Reference | BTG-PACTUAL-RFP-202603-11 |
| Document Type | RFP |
...
| Workstream 2 | Configuration of the platform for institutional digital asset custody and trading in Brazil, including product templates, token or asset models, workflow approvals, entitlement structures, reporting schemas, data retention rules and control checkpoints. |
...
| FR-10 | Support phased rollout by entity, geography, participant segment, product or workflow while preserving shared control patterns for institutional digital asset custody and trading in Brazil. | Mandatory | Narrative + evidence | Rollout plan / tenancy model |
...
| FR-13 | Support integration patterns specific to the buyer environment, including Mynt custody/trading stack, capital markets systems, portfolio management tools, liquidity controls, B3 connectivity and Brazil-specific compliance tooling. | Mandatory | Narrative + evidence | Target-state integration blueprint |
...
|---|---|---|
| Functional fit and workflow coverage | 22% | Alignment to the target operating model for institutional digital asset custody and trading in Brazil and realism of end-to-end lifecycle coverage |
...
For BTG Pactual, respondents should assume the institution will require a formal governance pack covering scope, controls, stakeholders, escalation paths, evidentiary outputs, operational ownership, release checkpoints, model/rules governance and board- or committee-level reporting before any production release. That pack must be capable of supporting audit and management review over time.

### 8.7 Integration inventory template
| Area | Illustrative scope |
|---|---|
| Internal systems | Mynt custody/trading stack, capital markets systems, portfolio management tools, liquidity controls, B3 connectivity and Brazil-specific compliance tooling. |
...
The bidder shall also address operational compliance design for institutional digital asset custody and trading in Brazil. This includes wallet segregation, key-governance controls, asset movement approvals, inventory reconciliation and exception-case casework. Where the regulatory perimeter depends on business structure, the bidder shall present configurable options together with the residual responsibilities that remain with BTG Pactual. Responses must identify what evidence is generated natively, what is derived via integration, how timestamps are normalised across components, and how legal-entity, desk or participant segmentation is preserved in both the live operating model and archived records.
