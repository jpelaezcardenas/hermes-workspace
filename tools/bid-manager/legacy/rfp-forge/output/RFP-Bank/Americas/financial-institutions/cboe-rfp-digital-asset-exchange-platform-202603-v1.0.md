...
| Document Reference | CBOE-RFP-202603-05 |
| Document Type | RFP |
...
| Workstream 2 | Configuration of the platform for digital asset exchange platform for regulated trading, including product templates, token or asset models, workflow approvals, entitlement structures, reporting schemas, data retention rules and control checkpoints. |
...
| FR-10 | Support phased rollout by entity, geography, participant segment, product or workflow while preserving shared control patterns for digital asset exchange platform for regulated trading. | Mandatory | Narrative + evidence | Rollout plan / tenancy model |
...
| FR-13 | Support integration patterns specific to the buyer environment, including exchange platforms, market data distribution, surveillance, clearing interfaces and broker connectivity. | Mandatory | Narrative + evidence | Target-state integration blueprint |
...
|---|---|---|
| Functional fit and workflow coverage | 22% | Alignment to the target operating model for digital asset exchange platform for regulated trading and realism of end-to-end lifecycle coverage |
...
For Cboe, respondents should assume the institution will require a formal governance pack covering scope, controls, stakeholders, escalation paths, evidentiary outputs, operational ownership, release checkpoints, model/rules governance and board- or committee-level reporting before any production release. That pack must be capable of supporting audit and management review over time.

### 8.7 Integration inventory template
| Area | Illustrative scope |
|---|---|
| Internal systems | exchange platforms, market data distribution, surveillance, clearing interfaces and broker connectivity. |
...
The following scenarios are intended to test whether the proposed platform can keep Cboe's control environment intact while supporting digital asset exchange platform for regulated trading. Respondents shall describe native product behaviour, configuration points, integration dependencies, operational ownership, evidence outputs and fallback procedures for each scenario.
...
For avoidance of doubt, Cboe will treat unanswered delivery-risk questions as a material weakness even where the product appears functionally strong. The bidder should therefore identify non-standard assumptions, unresolved third-party dependencies, minimum-volume thresholds, jurisdictional constraints, roadmap items, implementation accelerators that require buyer resources, and any feature areas where manual controls remain necessary for digital asset exchange platform for regulated trading. This clarification section should also state what the buyer must provide to keep timeline, budget and control outcomes realistic.
