...
| Document Reference | NASDAQ-RFP-202603-04 |
| Document Type | RFP |
...
| Workstream 2 | Configuration of the platform for tokenized marketplace technology for exchanges and alternative venues, including product templates, token or asset models, workflow approvals, entitlement structures, reporting schemas, data retention rules and control checkpoints. |
...
| FR-10 | Support phased rollout by entity, geography, participant segment, product or workflow while preserving shared control patterns for tokenized marketplace technology for exchanges and alternative venues. | Mandatory | Narrative + evidence | Rollout plan / tenancy model |
...
| FR-13 | Support integration patterns specific to the buyer environment, including market technology stacks, issuer services, surveillance, order-routing / matching technology and digital custody or registrar dependencies. | Mandatory | Narrative + evidence | Target-state integration blueprint |
...
|---|---|---|
| Functional fit and workflow coverage | 22% | Alignment to the target operating model for tokenized marketplace technology for exchanges and alternative venues and realism of end-to-end lifecycle coverage |
...
The bidder shall also address operational compliance design for tokenized marketplace technology for exchanges and alternative venues. This includes participant permissioning, market-data integrity, order or listing workflow approvals, surveillance evidence and clearing interface resiliency. Where the regulatory perimeter depends on business structure, the bidder shall present configurable options together with the residual responsibilities that remain with Nasdaq. Responses must identify what evidence is generated natively, what is derived via integration, how timestamps are normalised across components, and how legal-entity, desk or participant segmentation is preserved in both the live operating model and archived records.
...
The following scenarios are intended to test whether the proposed platform can keep Nasdaq's control environment intact while supporting tokenized marketplace technology for exchanges and alternative venues. Respondents shall describe native product behaviour, configuration points, integration dependencies, operational ownership, evidence outputs and fallback procedures for each scenario.
...
For avoidance of doubt, Nasdaq will treat unanswered delivery-risk questions as a material weakness even where the product appears functionally strong. The bidder should therefore identify non-standard assumptions, unresolved third-party dependencies, minimum-volume thresholds, jurisdictional constraints, roadmap items, implementation accelerators that require buyer resources, and any feature areas where manual controls remain necessary for tokenized marketplace technology for exchanges and alternative venues. This clarification section should also state what the buyer must provide to keep timeline, budget and control outcomes realistic.
