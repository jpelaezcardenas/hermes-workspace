# Request for Proposal (RFP): Tokenized Derivatives Clearing

| Field | Value |
| --- | --- |
| Reference number | EUREX-RFP-202603 |
| Version | v1.0 |
| Issue date | March 2026 |
| Issuing institution | Eurex |
| Jurisdiction | Germany |
| Currency | EUR |
| Governing law / policy basis | German law |
...
The buyer’s strategic intent is not to replace governance with technology; it is to make governance executable inside the technology stack. Any proposed solution must therefore support robust segregation of duties, transparent operator actions, well-defined failure handling, and integration into established risk and assurance processes. The buyer expects detailed disclosure of solution boundaries, assumptions, and third-party dependencies. Eurex reserves the right to reject any proposal that relies on unclear roadmap commitments, unsupported legal assumptions, or immature operational models. Applicable regulatory reference points include EMIR, DORA, CSDR interfaces where relevant, GDPR, AMLD, NIS2. These references are not exhaustive and vendors remain responsible for identifying any other frameworks relevant to the proposed delivery model.

### 1.2 Procurement Objectives and Target Outcomes
The buyer is seeking a bidder or consortium capable of delivering a controlled and supportable capability for **tokenized derivatives clearing**. The procurement objectives below are cumulative. Failure to support a mandatory objective may result in rejection.
...
| Scalable processing | Support risk management, margin processing, clearing certainty, control transparency, and integration with default management workflows. | High |
| Regulatory alignment | Provide evidence aligned to EMIR, DORA, CSDR interfaces where relevant, GDPR, AMLD, NIS2. | Mandatory |
...
| Workflow configuration | Yes | Production support for tokenized derivatives clearing processes, approvals, exceptions, and reporting |
...
| --- | --- | --- | --- | --- |
| TR-001 | P1 | Support clearing-member onboarding, account structures, and segregation model controls. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-002 | P1 | Provide trade capture, novation-state handling, and position management for cleared tokenized derivatives. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-003 | P1 | Support initial margin, variation margin, and intraday margin processes with deterministic controls. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-004 | P1 | Provide default-management workflow support, auction preparation data, and emergency access controls. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-005 | P1 | Support collateral linkage, concentration rules, and eligibility constraints for margin assets. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-006 | P2 | Provide stress-testing hooks, scenario input support, and model-output traceability. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-007 | P2 | Support position transfer, give-up/take-up, and correction workflows. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-008 | P2 | Provide end-of-day valuation, reconciliation, and member statement outputs. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-009 | P2 | Support legal-entity and account-level netting assumptions with documented control boundaries. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-010 | P3 | Provide integration options with risk engines, treasury systems, and regulatory reporting platforms. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
...
1. **TR-001 (P1)** — Support clearing-member onboarding, account structures, and segregation model controls.
2. **TR-002 (P1)** — Provide trade capture, novation-state handling, and position management for cleared tokenized derivatives.
3. **TR-003 (P1)** — Support initial margin, variation margin, and intraday margin processes with deterministic controls.
4. **TR-004 (P1)** — Provide default-management workflow support, auction preparation data, and emergency access controls.
5. **TR-005 (P1)** — Support collateral linkage, concentration rules, and eligibility constraints for margin assets.
6. **TR-006 (P2)** — Provide stress-testing hooks, scenario input support, and model-output traceability.
7. **TR-007 (P2)** — Support position transfer, give-up/take-up, and correction workflows.
8. **TR-008 (P2)** — Provide end-of-day valuation, reconciliation, and member statement outputs.
9. **TR-009 (P2)** — Support legal-entity and account-level netting assumptions with documented control boundaries.
10. **TR-010 (P3)** — Provide integration options with risk engines, treasury systems, and regulatory reporting platforms.
...
The buyer operates within Germany and expects bidder responses to align with the applicable supervisory and policy environment, including engagement with BaFin, Deutsche Bundesbank, ESMA where relevant, and ECB supervisory interfaces where applicable. Bidders remain responsible for identifying any additional regulatory, legal, or policy constraints triggered by their proposed architecture, operating model, subcontracting chain, hosting arrangement, or data handling approach. Stating that “compliance is the buyer’s responsibility” will be treated as an inadequate answer where the bidder’s design choices create or increase regulatory exposure.

### 3.2 Regulatory Requirement Set
| ID | Control area | Requirement |
| --- | --- | --- |
| REG-001 | Applicable framework mapping | Bidders shall map the proposed solution and delivery model against EMIR, DORA, CSDR interfaces where relevant, GDPR, AMLD, NIS2 and identify any jurisdiction-specific limitations or dependencies. |
