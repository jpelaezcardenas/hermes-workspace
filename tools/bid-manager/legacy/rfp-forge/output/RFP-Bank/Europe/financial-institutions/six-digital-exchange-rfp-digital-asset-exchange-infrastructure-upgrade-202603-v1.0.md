# Request for Proposal (RFP): Digital Asset Exchange Infrastructure Upgrade

| Field | Value |
| --- | --- |
| Reference number | SIXDIGITALEXCHANGE-RFP-202603 |
| Version | v1.0 |
...
The buyer is seeking a bidder or consortium capable of delivering a controlled and supportable capability for **digital asset exchange infrastructure upgrade**. The procurement objectives below are cumulative. Failure to support a mandatory objective may result in rejection.
...
| Scalable processing | Support throughput, deterministic latency, venue integrity, participant risk controls, and exchange-grade observability. | High |
| Regulatory alignment | Provide evidence aligned to FMIA, FINMA circulars and outsourcing guidance, Swiss Data Protection Act, AMLA, CPMI-IOSCO PFMI where relevant. | Mandatory |
...
| Workflow configuration | Yes | Production support for digital asset exchange infrastructure upgrade processes, approvals, exceptions, and reporting |
