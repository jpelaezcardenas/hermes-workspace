# Request for Proposal (RFP): Digital Asset Marketplace Platform

| Field | Value |
| --- | --- |
| Reference number | LONDONSTOCKEXCHANGEGROUP-RFP-202603 |
| Version | v1.0 |
...
The buyer is seeking a bidder or consortium capable of delivering a controlled and supportable capability for **digital asset marketplace platform**. The procurement objectives below are cumulative. Failure to support a mandatory objective may result in rejection.
...
| Scalable processing | Support listing controls, venue governance, latency-sensitive operations, surveillance integration, and orderly market management. | High |
| Regulatory alignment | Provide evidence aligned to UK FMI regulatory framework, Operational Resilience rules, UK GDPR, MLR 2017, Digital Securities Sandbox considerations where relevant. | Mandatory |
...
| Workflow configuration | Yes | Production support for digital asset marketplace platform processes, approvals, exceptions, and reporting |
