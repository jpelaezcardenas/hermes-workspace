...
| Field | Value |
| --- | --- |
| Reference | `REVOLUT-RFP-TOKENIZED-SECURITIES-TRADING-PLATFORM-202603` |
| Version | v1.0 |
| Issue date | March 2026 |
| Issuing organization | Revolut (United Kingdom) |
| Procurement subject | Tokenized Securities Trading Platform |
...
The solution must support the end-to-end business and operational scenarios required for tokenized securities trading platform. At minimum, the buyer expects support for customer onboarding hooks, asset setup and governance, transaction or order processing, ledger and entitlement updates, reconciliation, reporting, exception handling, and controlled rollout into new jurisdictions or customer segments.
...
| Core platform capability | Native support for tokenized securities trading platform, including lifecycle and control workflows | Mandatory |
...
Evaluation will be performed by a cross-functional team spanning Product, Engineering, Security, Compliance, Operations, Treasury. The buyer may request clarification sessions, architecture walkthroughs, control deep-dives, or reference calls. Scores may be adjusted where written responses are contradicted by demo evidence, undocumented dependencies, or unclear operating assumptions.
