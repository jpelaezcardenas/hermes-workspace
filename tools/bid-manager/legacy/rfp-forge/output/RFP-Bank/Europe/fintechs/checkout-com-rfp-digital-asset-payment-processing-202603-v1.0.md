...
| Field | Value |
| --- | --- |
| Reference | `CHECKOUT-COM-RFP-DIGITAL-ASSET-PAYMENT-PROCESSING-202603` |
| Version | v1.0 |
| Issue date | March 2026 |
| Issuing organization | Checkout.com (United Kingdom) |
| Procurement subject | Digital Asset Payment Processing |
...
The selected vendor will be expected to deliver a production-capable solution aligned to the target operating model of Checkout.com. This means the bidder must cover both the visible product workflows and the underlying operational mechanics. A slick demo without ledger integrity, reconciliation, entitlement handling, environment controls, and evidence production is out of scope.
...
| Core platform capability | Native support for digital asset payment processing, including lifecycle and control workflows | Mandatory |
...
Evaluation will be performed by a cross-functional team spanning Platform Engineering, Product, Merchant Success, Risk, Compliance, Finance. The buyer may request clarification sessions, architecture walkthroughs, control deep-dives, or reference calls. Scores may be adjusted where written responses are contradicted by demo evidence, undocumented dependencies, or unclear operating assumptions.
