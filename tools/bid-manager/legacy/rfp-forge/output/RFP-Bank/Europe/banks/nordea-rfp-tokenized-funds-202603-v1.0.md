...
# Nordea — Request for Proposal
## Tokenized Funds Platform

| Field | Value |
|-------|-------|
| **Document Reference** | NORDEA-RFP-202603-09 |
| **Version** | v1.0 |
| **Issue Date** | March 2026 |
| **Submission Deadline** | May 2026 |
| **Classification** | Confidential |
| **Issuing Entity** | Nordea Bank Abp |
...
- Support new digital fund distribution models across nordic and eu markets.
- Reduce reconciliation friction between transfer agency, custody, and payment events.
- Evaluate digital payment capabilities that may support treasury and client transaction flows across borders.

Solutions should fit a multi-country governance model and provide transparent control handoffs across banking product teams. The buyer expects vendors to respond in a disciplined, evidence-backed manner and to distinguish clearly between delivered functionality, configurable functionality, partner-enabled capability, and roadmap items.
...
The governing regulatory context includes MiCA, MiFID II, UCITS, AIFMD, DORA, GDPR, Nordic supervisory expectations. Vendors remain responsible for identifying any additional regulatory dependencies relevant to their proposed architecture, hosting model, and service delivery structure.
...
The buyer requires proposals that are workable within the Nordic and EU regulatory perimeter. Responses shall explain how the proposed platform supports a regulated financial institution operating under MiCA, MiFID II, UCITS, AIFMD, DORA, GDPR, Nordic supervisory expectations. The response must distinguish between obligations addressed by product design, obligations addressed through buyer policy or operating procedure, and obligations dependent on third-party service providers.
