...
# Request for Proposal: Digital Bond Issuance Platform for Institutional Capital Markets Use Cases
...
This RFP covers digital bond issuance for wholesale and selected private placement use cases, including origination workflow support, issuance approval checkpoints, subscription and allocation data handling, token creation and registry updates, coupon servicing, redemptions, event-driven restrictions, and downstream reporting. Out of scope are retail wallet applications, public-crypto distribution and unregulated settlement environments.
