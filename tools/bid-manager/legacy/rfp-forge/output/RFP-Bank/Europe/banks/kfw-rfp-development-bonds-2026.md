...
country: Germany
document-type: rfp
asset-class: development-bonds
date: 2026-03-14
version: v1.0
reference: KFW-2026-001
---

# Request for Proposal: Digital Development Bond Issuance and Servicing Platform
...
This RFP covers digital development bond issuance and servicing, including workflow orchestration, investor record support, allocation and transfer controls, coupon and redemption automation, registry and reconciliation functions, reporting interfaces and strong audit traceability. Retail distribution, unregulated trading venues and unsupported public-chain dependencies are out of scope.
