...
# Société Générale — Request for Proposal
## Digital Bonds Platform (FORGE-like)

| Field | Value |
|-------|-------|
| **Document Reference** | SG-RFP-202603-07 |
| **Version** | v1.0 |
...
- Extend digital debt market capabilities with stronger industrialisation and governance.
- Support institutional issuance, settlement, and servicing under french and eu controls.
- Integrate digital asset operating controls with established capital markets oversight.

Responses should show how the proposed platform differentiates between pilot-grade issuance and scaled operational production. The buyer expects vendors to respond in a disciplined, evidence-backed manner and to distinguish clearly between delivered functionality, configurable functionality, partner-enabled capability, and roadmap items.

### 1.2 Procurement objectives and intended outcomes
The objective of this procurement is to identify one or more vendors able to provide a platform and associated implementation services suitable for the bank's target operating model for digital bonds (forge-like). The desired outcome is not simply a technology deployment; it is a control-aligned operating capability that can be governed by the buyer as a regulated institution. Vendors must therefore demonstrate not only product breadth but also implementation realism, control design maturity, and credible long-term supportability.
...
The governing regulatory context includes MiCA, MiFID II, French digital securities rules, AMF doctrine, DORA, GDPR. Vendors remain responsible for identifying any additional regulatory dependencies relevant to their proposed architecture, hosting model, and service delivery structure.
...
|---|---|---|---|---|
| TR-01 | The platform shall support end-to-end lifecycle management for digital bonds (forge-like) including origination, onboarding, issuance, servicing, transfer, redemption, and archival record retention. | Mandatory | Comply + narrative | Solution architecture and workflow diagrams |
...
The buyer requires proposals that are workable within the French and EU regulatory perimeter. Responses shall explain how the proposed platform supports a regulated financial institution operating under MiCA, MiFID II, French digital securities rules, AMF doctrine, DORA, GDPR. The response must distinguish between obligations addressed by product design, obligations addressed through buyer policy or operating procedure, and obligations dependent on third-party service providers.
