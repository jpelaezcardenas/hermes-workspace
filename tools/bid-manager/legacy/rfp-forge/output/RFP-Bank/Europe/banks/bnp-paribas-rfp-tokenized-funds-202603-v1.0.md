...
# BNP Paribas — Request for Proposal
## Tokenized Funds Platform

| Field | Value |
|-------|-------|
| **Document Reference** | BNPP-RFP-202603-02 |
| **Version** | v1.0 |
| **Issue Date** | March 2026 |
| **Submission Deadline** | May 2026 |
| **Classification** | Confidential |
| **Issuing Entity** | BNP Paribas S.A. |
...
- Enable tokenized fund issuance, transfer agency coordination, and investor servicing across eligible jurisdictions.
- Support fund distribution and nominee operating models without fragmenting existing asset servicing controls.
- Create auditable links between fund accounting, share register management, and digital asset records.

Solutions must demonstrate suitability for complex investor eligibility, nominee arrangements, and high-quality transfer agency data controls. The buyer expects vendors to respond in a disciplined, evidence-backed manner and to distinguish clearly between delivered functionality, configurable functionality, partner-enabled capability, and roadmap items.

### 1.2 Procurement objectives and intended outcomes
The objective of this procurement is to identify one or more vendors able to provide a platform and associated implementation services suitable for the bank's target operating model for tokenized funds. The desired outcome is not simply a technology deployment; it is a control-aligned operating capability that can be governed by the buyer as a regulated institution. Vendors must therefore demonstrate not only product breadth but also implementation realism, control design maturity, and credible long-term supportability.
...
The governing regulatory context includes MiCA, MiFID II, AIFMD, UCITS, DORA, GDPR, AMF doctrine and French securities law. Vendors remain responsible for identifying any additional regulatory dependencies relevant to their proposed architecture, hosting model, and service delivery structure.
...
|---|---|---|---|---|
| TR-01 | The platform shall support end-to-end lifecycle management for tokenized funds including origination, onboarding, issuance, servicing, transfer, redemption, and archival record retention. | Mandatory | Comply + narrative | Solution architecture and workflow diagrams |
...
The buyer requires proposals that are workable within the French and EU regulatory perimeter. Responses shall explain how the proposed platform supports a regulated financial institution operating under MiCA, MiFID II, AIFMD, UCITS, DORA, GDPR, AMF doctrine and French securities law. The response must distinguish between obligations addressed by product design, obligations addressed through buyer policy or operating procedure, and obligations dependent on third-party service providers.
