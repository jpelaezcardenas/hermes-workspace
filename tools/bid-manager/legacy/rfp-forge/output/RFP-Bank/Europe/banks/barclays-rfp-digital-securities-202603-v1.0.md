...
# Barclays — Request for Proposal
## Digital Securities Platform

| Field | Value |
|-------|-------|
| **Document Reference** | BARC-RFP-202603-05 |
| **Version** | v1.0 |
| **Issue Date** | March 2026 |
| **Submission Deadline** | May 2026 |
| **Classification** | Confidential |
| **Issuing Entity** | Barclays Bank PLC |
...
- Establish a scalable platform for issuance, servicing, transfer, and reporting of digital securities.
- Support collateral-intensive workflows and inventory visibility across securities financing operations.
- Preserve control alignment between legal entity governance, markets supervision, and technology operations.

The buyer expects strong support for settlement finality controls, collateral mobility, and auditable entitlement records. The buyer expects vendors to respond in a disciplined, evidence-backed manner and to distinguish clearly between delivered functionality, configurable functionality, partner-enabled capability, and roadmap items.

### 1.2 Procurement objectives and intended outcomes
The objective of this procurement is to identify one or more vendors able to provide a platform and associated implementation services suitable for the bank's target operating model for digital securities. The desired outcome is not simply a technology deployment; it is a control-aligned operating capability that can be governed by the buyer as a regulated institution. Vendors must therefore demonstrate not only product breadth but also implementation realism, control design maturity, and credible long-term supportability.
...
The governing regulatory context includes UK FCA rules, PRA outsourcing and operational resilience expectations, MiFID II where relevant, UK GDPR, CSDR where EU market connectivity is in scope, DORA for EU interactions. Vendors remain responsible for identifying any additional regulatory dependencies relevant to their proposed architecture, hosting model, and service delivery structure.
...
|---|---|---|---|---|
| TR-01 | The platform shall support end-to-end lifecycle management for digital securities including origination, onboarding, issuance, servicing, transfer, redemption, and archival record retention. | Mandatory | Comply + narrative | Solution architecture and workflow diagrams |
...
The buyer requires proposals that are workable within the UK and cross-border regulatory perimeter. Responses shall explain how the proposed platform supports a regulated financial institution operating under UK FCA rules, PRA outsourcing and operational resilience expectations, MiFID II where relevant, UK GDPR, CSDR where EU market connectivity is in scope, DORA for EU interactions. The response must distinguish between obligations addressed by product design, obligations addressed through buyer policy or operating procedure, and obligations dependent on third-party service providers.
