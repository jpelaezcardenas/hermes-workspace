...
| Field | Value |
| --- | --- |
| Reference | TAMARA-RFI-SHARIA-TOKENIZED-LENDING-202603 |
| Version | v1.0 |
...
This RFI is intended to establish market maturity for Sharia-compliant tokenized lending and funding
rails, compare delivery models, and understand which suppliers can support a credible route to
...
Sharia-compliant tokenized lending and funding rails, including onboarding, policy setup, role
...
| DQ-09 | Support Sharia board workflows, fatwa references, and AAOIFI documentation treatment. | Status label + explanation + evidence reference |
| DQ-10 | Evidence segregation between permissible profit logic and prohibited interest-like treatment. | Status label + explanation + evidence reference |
...
platform supports multiple deployment patterns, state which one is most appropriate for Tamara and
why.
...
Address the practical regulatory context for KSA, including SAMA regulatory expectations, CMA
capital markets rules, Saudi cybersecurity and data controls, AML/CFT requirements, cloud and
outsourcing expectations, Sharia governance and AAOIFI considerations. If the target use case would
require specific licences, partner structures, or buyer legal interpretation, say so. The buyer
values clear perimeter statements over broad claims of universal compliance.
...
Describe a realistic delivery model for a programme comparable to Sharia-compliant tokenized lending
and funding rails, covering discovery, design, configuration, integration, testing, training,
...
RFI responses will be reviewed for clarity, completeness, relevance to Sharia-compliant tokenized
lending and funding rails, evidence quality, dependency transparency, and credibility of the implied
...
Use this appendix to make the operating reality of Sharia-compliant tokenized lending and funding
rails clear to Tamara. The buyer is particularly interested in evidence quality, dependency
...
Respondents should interpret market maturity carefully. For Tamara, the question is not simply
whether Sharia-Compliant Tokenized Lending And Funding Rails can be demonstrated, but whether it can
be governed, integrated, supported, and evidenced in a way that survives institutional scrutiny. The
...
In reviewing responses, Tamara will focus on how data and control travel together. Respondents
...
layer, or specialist subsystem for Sharia-Compliant Tokenized Lending And Funding Rails, and what
that means for reconciliation and support.

### 8.7 Implementation realism interpretation

Implementation timelines should reflect actual delivery conditions in KSA. If readiness depends on
...
scenarios. For Tamara, this includes not only implementation and subscription levels, but also
