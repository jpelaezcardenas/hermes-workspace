...
| Field | Value |
| --- | --- |
| Reference | SOUTH-AFRICAN-RESERVE-BANK-RFI-PROJECT-KHOKHA-CBDC-202603 |
| Version | v1.0 |
...
This RFI is intended to establish market maturity for Project Khokha-aligned CBDC and tokenized
settlement support, compare delivery models, and understand which suppliers can support a credible
...
Project Khokha-aligned CBDC and tokenized settlement support, including onboarding, policy setup,
...
platform supports multiple deployment patterns, state which one is most appropriate for South
African Reserve Bank and why.
...
Describe a realistic delivery model for a programme comparable to Project Khokha-aligned CBDC and
tokenized settlement support, covering discovery, design, configuration, integration, testing,
...
RFI responses will be reviewed for clarity, completeness, relevance to Project Khokha-aligned CBDC
and tokenized settlement support, evidence quality, dependency transparency, and credibility of the
...
Use this appendix to make the operating reality of Project Khokha-aligned CBDC and tokenized
settlement support clear to South African Reserve Bank. The buyer is particularly interested in
...
Respondents should interpret market maturity carefully. For South African Reserve Bank, the question
is not simply whether Project Khokha-Aligned Cbdc And Tokenized Settlement Support can be
...
In reviewing responses, South African Reserve Bank will focus on how data and control travel
...
layer, or specialist subsystem for Project Khokha-Aligned Cbdc And Tokenized Settlement Support, and
...
scenarios. For South African Reserve Bank, this includes not only implementation and subscription
