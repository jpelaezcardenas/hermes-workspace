...
| Document Reference | DTCC-RFI-202603-03 |
| Document Type | RFI |
...
The institution is particularly interested in whether the market can support production-grade control patterns, buyer-operated governance, evidence retention and integration realism for digital securities settlement and post-trade recordkeeping. Responses should therefore be explicit about maturity, limitations, assumptions and buyer prerequisites.
...
| DQ-06 | Describe how the solution would integrate with buyer infrastructure, including DTC, NSCC and post-trade recordkeeping platforms, participant messaging, reconciliation layers, supervisory reporting and synchronized settlement workflows. | High | Narrative + status | Supporting artefact or explanation |
...
For DTCC, respondents should assume the institution will require a formal governance pack covering scope, controls, stakeholders, escalation paths, evidentiary outputs and operational ownership before any production release. That pack must be capable of supporting audit and management review over time.
