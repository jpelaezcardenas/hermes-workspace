...
# Deutsche Bank — Request for Information
## Tokenized Deposits Capability

| Field | Value |
|-------|-------|
| **Document Reference** | DB-RFI-202603-01 |
| **Version** | v1.0 |
...
| SQ-02 | Explain how your solution aligns or can be aligned with the following regulatory themes: MiCA, MiFID II, CSDR, German Electronic Securities Act (eWpG), DORA, GDPR, BaFin guidance on crypto securities and custody. | Narrative + status | Narrative response | Compliance mapping |
