...
# Credit Agricole — Request for Information
## ESG Token Framework Capability

| Field | Value |
|-------|-------|
| **Document Reference** | CA-RFI-202603-11 |
| **Version** | v1.0 |
...
|---|---|---|---|---|
| BQ-01 | Describe your current capability to support esg token framework capability across origination, onboarding, creation, lifecycle management, reporting, and retirement. | Narrative + status | Narrative response | Workflow diagrams or product notes |
...
| SQ-02 | Explain how your solution aligns or can be aligned with the following regulatory themes: MiCA, MiFID II, EU Green Bond Regulation, SFDR, CSRD, DORA, GDPR, AMF guidance. | Narrative + status | Narrative response | Compliance mapping |
