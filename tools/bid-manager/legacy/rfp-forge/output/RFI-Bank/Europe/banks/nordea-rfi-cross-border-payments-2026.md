...
country: Finland
document-type: rfi
asset-class: cross-border-payments
date: 2026-03-14
version: v1.0
reference: NOR-2026-002
---

# Request for Information: Cross-Border Payment Orchestration in Digital Asset Operating Models
...
This RFI seeks market information on solutions for cross-border payments and associated settlement orchestration in a digital asset environment. We are interested in multi-currency controls, liquidity prefunding reduction, sanctions and screening integration, ISO 20022 alignment, conditional payment workflows, and interoperability with existing transaction banking infrastructure rather than retail wallet models.
