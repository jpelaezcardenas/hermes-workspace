...
# ING Group — Request for Information
## Digital Bonds Capability

| Field | Value |
|-------|-------|
| **Document Reference** | ING-RFI-202603-06 |
| **Version** | v1.0 |
...
|---|---|---|---|---|
| BQ-01 | Describe your current capability to support digital bonds capability across origination, onboarding, creation, lifecycle management, reporting, and retirement. | Narrative + status | Narrative response | Workflow diagrams or product notes |
...
| SQ-02 | Explain how your solution aligns or can be aligned with the following regulatory themes: MiCA, MiFID II where securities treatment applies, DORA, GDPR, Dutch financial supervision requirements, trade finance AML and sanctions obligations. | Narrative + status | Narrative response | Compliance mapping |
