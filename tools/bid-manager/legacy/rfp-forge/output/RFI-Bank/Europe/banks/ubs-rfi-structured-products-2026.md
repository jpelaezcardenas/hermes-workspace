...
date: 2026-03-14
version: v1.0
reference: UBS-2026-002
---

# Request for Information: Structured Products Digital Lifecycle Solutions
...
This RFI concerns structured products as the primary asset class. The Bank is seeking structured market information and does not intend this document to create any binding procurement obligation, shortlist commitment or volume commitment. The in-scope scenarios include Exploratory study of lifecycle support for digitally represented structured products, including issuance parameterization, distributor allocations, event observation, payoff calculation integration and investor reporting.
