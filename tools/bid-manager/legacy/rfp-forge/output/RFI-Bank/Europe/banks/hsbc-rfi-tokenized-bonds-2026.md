...
date: 2026-03-14
version: v1.0
reference: HSBC-2026-002
---

# Request for Information: Tokenized Bonds Capability Review
...
This RFI concerns tokenized bonds as the primary asset class. The Bank is seeking structured market information and does not intend this document to create any binding procurement obligation, shortlist commitment or volume commitment. The in-scope scenarios include Exploratory understanding of the maturity of tokenized bond issuance, distribution, servicing and settlement across sterling and multi-currency use cases. This RFI is not a commitment to proceed.
