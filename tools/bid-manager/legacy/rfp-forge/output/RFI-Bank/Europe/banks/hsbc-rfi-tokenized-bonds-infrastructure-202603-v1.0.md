...
# HSBC — Request for Information
## Tokenized Bonds Infrastructure Capability

| Field | Value |
|-------|-------|
| **Document Reference** | HSBC-RFI-202603-04 |
| **Version** | v1.0 |
...
|---|---|---|---|---|
| BQ-01 | Describe your current capability to support tokenized bonds infrastructure capability across origination, onboarding, creation, lifecycle management, reporting, and retirement. | Narrative + status | Narrative response | Workflow diagrams or product notes |
...
| SQ-02 | Explain how your solution aligns or can be aligned with the following regulatory themes: UK FCA and PRA operational resilience expectations, UK data protection law, DORA where EU branches interact, MiFID II for relevant markets activity, Payment Services Regulations where applicable. | Narrative + status | Narrative response | Compliance mapping |
...
Responses should map the requested capability against UK FCA and PRA operational resilience expectations, UK data protection law, DORA where EU branches interact, MiFID II for relevant markets activity, Payment Services Regulations where applicable. The buyer is not asking vendors to provide legal advice; it is asking them to explain how their platform supports institution-led compliance, recordkeeping, access control, auditability, resilience, and outsourcing oversight. Where the capability is restricted by geography, legal structure, client type, or market infrastructure dependency, that should be stated directly.
