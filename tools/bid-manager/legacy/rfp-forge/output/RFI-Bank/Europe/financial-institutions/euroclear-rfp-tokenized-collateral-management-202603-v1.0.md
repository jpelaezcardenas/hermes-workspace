# Request for Information (RFI): Tokenized Collateral Management

| Field | Value |
| --- | --- |
| Reference number | EUROCLEAR-RFI-202603 |
| Version | v1.0 |
...
| --- | --- | --- | --- | --- |
| TR-001 | P1 | Support collateral eligibility rule definition by asset, counterparty, jurisdiction, concentration, tenor, and haircut. | Detailed narrative, architecture diagram, control description, and client reference evidence | Current / Configured / Partner / Roadmap / Not supported |
| TR-002 | P1 | Provide substitution, top-up, revaluation, and recall workflow support with full auditability. | Detailed narrative, architecture diagram, control description, and client reference evidence | Current / Configured / Partner / Roadmap / Not supported |
| TR-003 | P1 | Support intraday position and exposure views for collateral providers, takers, and operators. | Detailed narrative, architecture diagram, control description, and client reference evidence | Current / Configured / Partner / Roadmap / Not supported |
| TR-004 | P1 | Provide integration patterns for custody, valuation, eligibility engines, and tri-party control points. | Detailed narrative, architecture diagram, control description, and client reference evidence | Current / Configured / Partner / Roadmap / Not supported |
| TR-005 | P1 | Support concentration limits, wrong-way risk checks, and issuer/counterparty constraint handling. | Detailed narrative, architecture diagram, control description, and client reference evidence | Current / Configured / Partner / Roadmap / Not supported |
| TR-006 | P2 | Provide event-driven collateral movement orchestration with controlled settlement dependencies. | Detailed narrative, architecture diagram, control description, and client reference evidence | Current / Configured / Partner / Roadmap / Not supported |
| TR-007 | P2 | Support dispute management, margin shortfall reporting, and exception escalation workflows. | Detailed narrative, architecture diagram, control description, and client reference evidence | Current / Configured / Partner / Roadmap / Not supported |
| TR-008 | P2 | Provide collateral inventory transparency across pledged, available, encumbered, and pending states. | Detailed narrative, architecture diagram, control description, and client reference evidence | Current / Configured / Partner / Roadmap / Not supported |
| TR-009 | P2 | Support digital asset and traditional asset coexistence within common control and reporting frameworks. | Detailed narrative, architecture diagram, control description, and client reference evidence | Current / Configured / Partner / Roadmap / Not supported |
| TR-010 | P3 | Provide end-of-day and intraday reporting suitable for treasury, risk, and oversight stakeholders. | Detailed narrative, architecture diagram, control description, and client reference evidence | Current / Configured / Partner / Roadmap / Not supported |
...
- **TR-001 (P1)** — Support collateral eligibility rule definition by asset, counterparty, jurisdiction, concentration, tenor, and haircut.
- **TR-002 (P1)** — Provide substitution, top-up, revaluation, and recall workflow support with full auditability.
- **TR-003 (P1)** — Support intraday position and exposure views for collateral providers, takers, and operators.
- **TR-004 (P1)** — Provide integration patterns for custody, valuation, eligibility engines, and tri-party control points.
- **TR-005 (P1)** — Support concentration limits, wrong-way risk checks, and issuer/counterparty constraint handling.
- **TR-006 (P2)** — Provide event-driven collateral movement orchestration with controlled settlement dependencies.
- **TR-007 (P2)** — Support dispute management, margin shortfall reporting, and exception escalation workflows.
- **TR-008 (P2)** — Provide collateral inventory transparency across pledged, available, encumbered, and pending states.
- **TR-009 (P2)** — Support digital asset and traditional asset coexistence within common control and reporting frameworks.
- **TR-010 (P3)** — Provide end-of-day and intraday reporting suitable for treasury, risk, and oversight stakeholders.
...
The buyer operates within a control perimeter shaped by National Bank of Belgium, FSMA, European Central Bank oversight where applicable, and relevant EU supervisory authorities. Responses must therefore address how the offering would fit within the buyer’s oversight, security, audit, and data-governance expectations. A response that simply states “we are compliant” without mapping the relevant controls, evidence sources, and operating assumptions will be treated as weak.
