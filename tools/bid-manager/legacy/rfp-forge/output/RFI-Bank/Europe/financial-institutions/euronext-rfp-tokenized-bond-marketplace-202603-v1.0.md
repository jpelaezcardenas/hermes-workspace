# Request for Information (RFI): Tokenized Bond Marketplace

| Field | Value |
| --- | --- |
| Reference number | EURONEXT-RFI-202603 |
| Version | v1.0 |
...
The buyer operates within a control perimeter shaped by AFM, DNB where relevant, and applicable national competent authorities across Euronext markets. Responses must therefore address how the offering would fit within the buyer’s oversight, security, audit, and data-governance expectations. A response that simply states “we are compliant” without mapping the relevant controls, evidence sources, and operating assumptions will be treated as weak.
