# Request for Information (RFI): Tokenized Securities Custody

| Field | Value |
| --- | --- |
| Reference number | DEUTSCHEBORSE-RFI-202603 |
| Version | v1.0 |
...
| --- | --- | --- | --- | --- |
| TR-001 | P1 | Support segregated custody models, omnibus controls where allowed, and beneficial ownership evidence. | Detailed narrative, architecture diagram, control description, and client reference evidence | Current / Configured / Partner / Roadmap / Not supported |
| TR-002 | P1 | Provide wallet/key governance options, approval workflows, and secure recovery procedures. | Detailed narrative, architecture diagram, control description, and client reference evidence | Current / Configured / Partner / Roadmap / Not supported |
| TR-003 | P1 | Support asset servicing, entitlement processing, and instruction management across custody accounts. | Detailed narrative, architecture diagram, control description, and client reference evidence | Current / Configured / Partner / Roadmap / Not supported |
| TR-004 | P1 | Provide reconciliation across ledger, custody books, client books, and external control records. | Detailed narrative, architecture diagram, control description, and client reference evidence | Current / Configured / Partner / Roadmap / Not supported |
| TR-005 | P1 | Support settlement instruction release, hold, cancel, and amendment processes with audit trails. | Detailed narrative, architecture diagram, control description, and client reference evidence | Current / Configured / Partner / Roadmap / Not supported |
| TR-006 | P2 | Provide sanctions screening, address risk controls, and travel-rule alignment where applicable. | Detailed narrative, architecture diagram, control description, and client reference evidence | Current / Configured / Partner / Roadmap / Not supported |
| TR-007 | P2 | Support proof of control, asset availability reporting, and client statement generation. | Detailed narrative, architecture diagram, control description, and client reference evidence | Current / Configured / Partner / Roadmap / Not supported |
| TR-008 | P2 | Provide segregation controls for client assets versus house assets. | Detailed narrative, architecture diagram, control description, and client reference evidence | Current / Configured / Partner / Roadmap / Not supported |
| TR-009 | P2 | Support connectivity to external custodians, settlement venues, and compliance screening tools. | Detailed narrative, architecture diagram, control description, and client reference evidence | Current / Configured / Partner / Roadmap / Not supported |
| TR-010 | P3 | Provide business continuity procedures for custody operations and key-management incidents. | Detailed narrative, architecture diagram, control description, and client reference evidence | Current / Configured / Partner / Roadmap / Not supported |
...
- **TR-001 (P1)** — Support segregated custody models, omnibus controls where allowed, and beneficial ownership evidence.
- **TR-002 (P1)** — Provide wallet/key governance options, approval workflows, and secure recovery procedures.
- **TR-003 (P1)** — Support asset servicing, entitlement processing, and instruction management across custody accounts.
- **TR-004 (P1)** — Provide reconciliation across ledger, custody books, client books, and external control records.
- **TR-005 (P1)** — Support settlement instruction release, hold, cancel, and amendment processes with audit trails.
- **TR-006 (P2)** — Provide sanctions screening, address risk controls, and travel-rule alignment where applicable.
- **TR-007 (P2)** — Support proof of control, asset availability reporting, and client statement generation.
- **TR-008 (P2)** — Provide segregation controls for client assets versus house assets.
- **TR-009 (P2)** — Support connectivity to external custodians, settlement venues, and compliance screening tools.
- **TR-010 (P3)** — Provide business continuity procedures for custody operations and key-management incidents.
...
The buyer operates within a control perimeter shaped by BaFin, Deutsche Bundesbank where relevant, and ESMA/EU authorities as applicable. Responses must therefore address how the offering would fit within the buyer’s oversight, security, audit, and data-governance expectations. A response that simply states “we are compliant” without mapping the relevant controls, evidence sources, and operating assumptions will be treated as weak.
