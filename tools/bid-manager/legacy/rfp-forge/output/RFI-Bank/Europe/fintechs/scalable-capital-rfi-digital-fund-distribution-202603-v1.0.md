...
| Field | Value |
| --- | --- |
| Reference | `SCALABLE-CAPITAL-RFI-DIGITAL-FUND-DISTRIBUTION-202603` |
| Version | v1.0 |
| Issue date | March 2026 |
| Issuing organization | Scalable Capital (Germany) |
| Information request subject | Digital Fund Distribution |
...
| Contact point | scalable-capital-market-scan@issuer.example |
| Status | Non-binding market inquiry |

## 1. Procurement Context

Scalable Capital is conducting this RFI to understand the current vendor landscape for **digital fund distribution**. This is a market and capability scan, not an award-ready procurement. The purpose is to compare what vendors can do today, what can be configured quickly, what depends on partners, and what is still roadmap.
...
| Extension path | Whether the same foundation can support tokenized funds, investment wallets, portfolio servicing, reporting and disclosures over time |
...
This RFI covers functional capability, technical architecture, operating model, control framework, and indicative commercials for digital fund distribution. The buyer is interested in both minimum viable launch support and extension potential. Vendors should answer based on current product reality, not aspiration.
...
| --- | --- | --- |
| CQ-01 | Describe your current support for digital fund distribution. | Status label + 150-word summary |
