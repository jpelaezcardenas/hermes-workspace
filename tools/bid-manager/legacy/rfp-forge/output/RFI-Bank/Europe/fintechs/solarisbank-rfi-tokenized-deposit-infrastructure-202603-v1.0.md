...
| Field | Value |
| --- | --- |
| Reference | `SOLARISBANK-RFI-TOKENIZED-DEPOSIT-INFRASTRUCTURE-202603` |
| Version | v1.0 |
| Issue date | March 2026 |
| Issuing organization | Solarisbank (Germany) |
| Information request subject | Tokenized Deposit Infrastructure |
...
| Contact point | solarisbank-market-scan@issuer.example |
| Status | Non-binding market inquiry |

## 1. Procurement Context

Solarisbank is conducting this RFI to understand the current vendor landscape for **tokenized deposit infrastructure**. This is a market and capability scan, not an award-ready procurement. The purpose is to compare what vendors can do today, what can be configured quickly, what depends on partners, and what is still roadmap.
...
| Extension path | Whether the same foundation can support tokenized deposits, partner wallets, bank ledger sync, embedded finance APIs over time |
...
This RFI covers functional capability, technical architecture, operating model, control framework, and indicative commercials for tokenized deposit infrastructure. The buyer is interested in both minimum viable launch support and extension potential. Vendors should answer based on current product reality, not aspiration.
...
| --- | --- | --- |
| CQ-01 | Describe your current support for tokenized deposit infrastructure. | Status label + 150-word summary |
