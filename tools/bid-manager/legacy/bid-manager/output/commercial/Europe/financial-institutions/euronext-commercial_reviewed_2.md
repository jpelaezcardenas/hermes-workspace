...
graph LR
    subgraph Commercial Model
        A[Platform License<br/>Annual Subscription] --> B[Enterprise Tier<br/>Multi-Market]
        C[Implementation<br/>Fixed-Price Phases] --> D[28-Week Delivery]
        E[Support<br/>Premium Tier] --> F[DORA-Aligned SLA]
        G[Infrastructure<br/>EU Private Cloud] --> H[Euronext-Controlled]
    end
    B --> I[Total Cost of Ownership]
    D --> I
    F --> I
    H --> I
    I --> J[3-Year: EUR 5-8.5M<br/>vs Build: EUR 15-25M+]
```
...
%%{init: {'theme': 'base', 'themeVariables': { 'primaryColor': '#E8EAF6', 'primaryTextColor': '#000099', 'primaryBorderColor': '#000099', 'lineColor': '#000099', 'secondaryColor': '#FFF3E0', 'tertiaryColor': '#E8F5E9', 'background': '#FFFFFF' }}}%%
gantt
    title Euronext DALP Implementation Timeline (28 Weeks)
    ...
    section Phase 2
    Foundation and Deployment :a2, after a1, 4w

    section Phase 3
    Configuration and Compliance :a3, after a2, 5w

    section Phase 4
    Integration and Testing :a4, after a3, 9w

    section Phase 5
    Production and Parallel Run :a5, after a4, 4w
