...
### 8.3 Indicative ROI Illustration

The following example uses assumed figures (clearly labelled as indicative) to illustrate the ROI calculation methodology. LSEG-specific numbers will be developed jointly during Discovery.

**Assumptions (indicative only):**
- Annual operational cost saving from automated compliance and corporate actions: £2.5M
- Settlement risk capital release (bilateral model, £500M average daily exposure, 8% capital charge): £40M capital freed
- Annual cost of capital on released capital at 10%: £4.0M per annum
- DSS platform fee income on projected £1B annual transaction volume at 2bps: £2.0M per annum
- Year 1 total value: £8.5M gross (net of implementation cost: [CLIENT-SPECIFIC])
- Year 2 total value: £8.5M gross (full year, no implementation cost)
- Year 3 total value: £9.5M gross (revenue growth assumed)
- 3-year gross value: £26.5M

Against a 3-year TCO of [CLIENT-SPECIFIC], this indicative illustration generates a positive ROI in Year 1 and a substantial 3-year return. SettleMint's commitment is to validate or improve these figures against LSEG's actual numbers during Discovery.
...
| Source code escrow | Included in Enterprise license; third-party escrow agent; release conditions: insolvency or material breach by SettleMint unremedied after 30 days |
