...
API response (trade initiation): P50 82ms, P99 310ms. Settlement confirmation: P50 2.1s, P99 4.2s. Corporate action (dividend for 500,000 investors): 3.5 to 4.5 hours (chunked, no API degradation). Auto-scaling: HPA on CPU and queue depth; burst to 500 API pods.
...
|---|---|---|
| FCA COBS investor categorization | Supported | On-chain investor category compliance modules |
