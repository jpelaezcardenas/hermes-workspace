...
| Tokenized funds | AUM fee module, NAV feeds, conversion feature | CISA |
...
| TR-005 | FMIA settlement finality (Article 51) | Comply | XvP atomic completion constitutes finality; IBFT 2.0 immediate block finality; Chain Indexer finality record |
...
| TR-026 | PFMI Principle 1 - Legal basis | Comply | On-chain settlement finality, DLT Act alignment, Swiss legal counsel review |
| TR-027 | PFMI Principle 2 - Governance | Comply | GOVERNANCE_ROLE multi-sig, AccessManager RBAC, Board audit access via Asset Console |
| TR-028 | PFMI Principle 3 - Risk management | Comply | Compliance modules, real-time monitoring, operational risk controls |
| TR-029 | PFMI Principle 4 - Credit risk | Comply | XvP atomicity eliminates pre-settlement credit exposure |
| TR-030 | PFMI Principle 7 - Liquidity risk | Comply | T+0 DvP eliminates liquidity timing mismatch |
| TR-031 | PFMI Principle 9 - Money settlements | Comply | On-chain CHF token settlement, IBFT 2.0 finality |
| TR-032 | PFMI Principle 16 - Custody risk | Comply | HSM Key Guardian, no key co-mingling, FIPS 140-2 Level 3 options |
| TR-033 | PFMI Principle 17 - Operational risk | Comply | 99.99% SLA, HA dual-site, tested DR, incident response with FINMA notification |
| TR-034 | PFMI Principle 18 - Access | Comply | OnchainID, AccessManager, participant lifecycle management |
| TR-035 | ISO 27001 certification | Comply | Full ISO 27001; certificate and audit reports available for FINMA submission |
| TR-036 | SOC 2 Type II | Comply | Full SOC 2 Type II report available under NDA |
| TR-037 | HSM key management | Comply | Key Guardian with FIPS 140-2 Level 3 HSM; keys never in plaintext |
| TR-038 | MFA for all access | Comply | Mandatory MFA; step-up for blockchain writes |
| TR-039 | SAML 2.0 SSO | Comply | SAML 2.0 federation with SDX identity provider |
| TR-040 | Swiss data residency | Comply | All components deployed in Switzerland; Zurich primary, Geneva secondary |
| TR-041 | nDSG compliance | Comply | Data minimisation, Swiss residency, breach notification < 48h |
| TR-042 | 99.99% availability | Comply | Enterprise SLA; IBFT 2.0 consensus; HA application and database |
| TR-043 | Tested DR procedures | Comply | Quarterly DR tests; evidence packages available for FINMA PFMI assessment |
| TR-044 | Observability and monitoring | Comply | Grafana, VictoriaMetrics, Loki, Tempo; pre-built dashboards; 24/7 alerting |
| TR-045 | SIX Group integration capability | Comply | REST API integration with SIX payment services and data services |
