...
*Document Version 1.0 Reviewed. SettleMint NV. All capabilities described in this proposal are live in the current DALP platform unless explicitly marked [ROADMAP]. Roadmap items represent current development priorities and are not contractual commitments. SettleMint Confidential. Do not distribute without prior written consent from SettleMint NV.*
