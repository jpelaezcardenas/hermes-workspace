...
The honest framing is: DALP provides the cryptographic vote recording substrate (ERC-5805), but the full bondholder consent solicitation system requires integration with a governance workflow layer that NSRA would commission as part of the DIMP technical build.
...
SettleMint has delivered digital asset infrastructure for regulated financial institutions across capital markets, custody, and securities issuance use cases. The DALP platform is in production use by institutional clients in Europe, the Gulf Cooperation Council, and Southeast Asia. Specific client references are available under a mutual confidentiality agreement, which SettleMint will provide through the formal tender process.

The DALP codebase has been developed from the ground up for regulated markets, with full ERC-3643 compliance, production-ready deployment tooling, and an architecture designed for the constraints and requirements of licensed financial market infrastructure. SettleMint's team includes former capital markets technologists with direct experience in CSD modernisation programmes, post-trade infrastructure design, and regulatory engagement at national and supranational levels.
