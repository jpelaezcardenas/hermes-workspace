...
The Key Guardian service manages cryptographic key material with cryptographic security boundaries, routing signing requests to the appropriate backend based on key metadata. Keys never leave secure boundaries in plaintext.
