...
- 18 compliance module types — confirmed in compliance-and-identity.md (12 concrete module type IDs in discriminated-union schema, with additional types in validation)
