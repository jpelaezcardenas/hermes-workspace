/**
 * Jobs API proxy — forwards to Agent-e1 FastAPI /api/jobs
 */
 ...
 *
 * Some Agent-e1 gateway versions return a bare array instead of the expected
...
export const Route = createFileRoute('/api/agentone-jobs')({
  server: {
    handlers: {
      GET: async ({ request }) => {
