...
export const UPDATE_REMOTE_DEFINITIONS: Array<RemoteDefinition> = [
  {
    name: 'origin',
    label: 'Agent-e1',
    expectedRepo: 'agentone-workspace',
    aliases: ['agentone-workspace', 'hermes-workspace', 'outsourc-e/hermes-workspace'],
  },
  {
    name: 'upstream',
    label: 'Agent-e1 Agent',
    expectedRepo: 'agentone-agent',
    aliases: ['agentone-agent', 'agentone', 'hermes-agent', 'NousResearch/hermes-agent'],
  },
]
