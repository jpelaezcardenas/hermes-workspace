...
import { searchKnowledgeWithEvidence } from '../../../../server/knowledge-memory-fabric'
import { requireJsonContentType } from '../../../../server/rate-limit'

export const Route = createFileRoute('/api/knowledge/fabric/search')({
  server: {
    handlers: {
      POST: async ({ request }) => {
        ...
        try {
          ...
          return json(await searchKnowledgeWithEvidence({
