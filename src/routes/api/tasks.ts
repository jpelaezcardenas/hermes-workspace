/**
 * /api/tasks — alias of /api/claude-tasks
 *
 * Wave 2 Lane B (F03). Frontend src/stores/task-store.ts calls /api/tasks;
 * the canonical implementation lives at /api/claude-tasks. This file mounts
 * the same handler shape under the shorter path so the SPA does not need a
 * frontend change.
 */
