...
const TIPS: ReadonlyArray<Tip> = [
  ...
  },
  {
    ...
    body: "Agent-e1 loads skills into context on demand. Click any row in Skills Usage to jump to that skill's page and edit its SKILL.md — every change is hot-reloaded.",
    tone: 'info',
    cta: 'Open skills',
    href: '/skills',
    score: () => 4,
