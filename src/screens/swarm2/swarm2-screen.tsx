...
import { JamesMissionControlView } from './james-mission-control-view'
...
export const SWARM2_INFORMATION_HIERARCHY = [
  ...
  'Mission Control view: James organogram, managers, rooms, decisions, watchers, Kanban ledger, graph, and blocked side-effect gates.',
...
export const SWARM2_SURFACE_CONTRACT = {
  ...
  missionControlSurface: 'james-mission-control-readonly',
...
type ViewMode = 'cards' | 'mission' | 'kanban' | 'runtime' | 'reports'
      ...
      <div className="relative z-10 flex flex-col items-center gap-4">
        ...
        <div className="relative w-full pt-3">
          ...
          <div
            className={cn(
              'relative z-10',
              viewMode === 'mission' ? 'block' : 'hidden',
            )}
          >
            <JamesMissionControlView />
          </div>
