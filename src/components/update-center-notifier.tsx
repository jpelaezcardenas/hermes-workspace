...
const DISMISS_PREFIX = 'agentone-update-v2-dismissed:'
const NOTES_KEY = 'agentone-update-v2-release-notes'
const NOTES_SEEN_KEY = 'agentone-update-v2-release-notes-seen'
