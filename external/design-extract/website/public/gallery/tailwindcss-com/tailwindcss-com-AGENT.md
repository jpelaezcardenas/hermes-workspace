# You are building UI in the tailwindcss.com design system.
...
- headings   Title Case
- CTA verbs  ui · v · k · quick · check · index
...
```bash
npx designlang tailwindcss.com
```
...
Generated by designlang. Re-extract by running `npx designlang tailwindcss.com`.
