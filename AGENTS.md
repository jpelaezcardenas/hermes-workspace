...
| `multimodal` | `multimodal:vision` | Gemini 3.5 Flash multimodal lane | vision, browser, terminal, file, web, gbrain, session_search, skills, todo | multimodal-core, qa-core, browser-harness-power-use, gbrain, gstack-for-hermes | gbrain | image_gen/openai-codex, image_gen/gemini |
