# RFI Skeleton v3 — Technical Infrastructure and Deployment Assessment

**Document ID:** RB-RFI-03-v1.0
**Codename:** INFRA
**Category:** RFI
**Buyer type:** Technology, operations, architecture, or platform engineering buyer
**Primary intent:** Information gathering focused on deployment model, integration architecture, observability, resilience, and operations
**Default response model:** Structured vendor response with explicit evidence requests
**Tailoring variables:** hosting model, cloud strategy, on-prem constraints, integration landscape, resilience targets
...
- Write about: deployment models, architecture patterns, infrastructure prerequisites, environment management, observability, security boundaries, and operational supportability
...
- Use when the buyer wants to understand technical fit before issuing a detailed functional procurement
- Require vendors to state what is native, configurable, third-party dependent, or not supported in each infrastructure domain
- Include optional appendices for target-state topology and sample runbook inventory
