# RFP Skeleton v1 — Digital Bonds Issuance Platform

**Document ID:** RB-RFP-01-v1.0
**Codename:** BOND
**Category:** Full RFP
**Buyer type:** Central bank, sovereign debt office, or public-sector market authority
**Primary intent:** Formal procurement for a digital bond issuance and lifecycle platform
**Default response model:** Structured vendor response with explicit evidence requests
**Tailoring variables:** jurisdiction, issuance model, investor access model, settlement model, hosting preference
...
- Write about: Core architecture expectations for sovereign issuance workflows, book-building support, lifecycle servicing, registrar functions, cash/security leg coordination, and policy-controlled issuance operations
...
- Emphasize issuance governance, investor eligibility controls, coupon/redemption servicing, and central-bank-grade auditability
- Require vendors to describe how the platform supports both pilot issuance and scaled programmatic issuance
- Include an appendix for bond termsheet templates, issuance calendar assumptions, and stakeholder roles across issuer, registrar, CSD, paying agent, and investors
