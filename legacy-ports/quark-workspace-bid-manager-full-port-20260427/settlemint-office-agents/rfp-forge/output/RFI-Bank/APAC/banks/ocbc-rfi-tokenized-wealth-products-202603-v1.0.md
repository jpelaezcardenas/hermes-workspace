...
| Information request theme | Tokenized Wealth Products |
| Reference | OCBC-RFI-202603 |
| Version | v1.0 |
...
OCBC is conducting a structured market-sounding exercise in relation to **tokenized wealth products**. This Request for Information is issued for information-gathering purposes only. It does **not** constitute a commitment to procure, a binding tender, or an obligation to issue a subsequent RFP. That said, the institution is not looking for airy thought leadership either. It wants grounded information that can support internal option analysis, control design, sequencing decisions, and eventual investment cases.

The institution is seeking to understand current market maturity, viable operating models, regulatory implications, integration patterns, and delivery risks relevant to the target use case in Singapore. Publicly visible market material reviewed during pre-RFI shaping suggests that the environment around OCBC is being shaped by wealth platform modernization, private banking product digitisation, Singapore tokenized investment distribution trends. Directional research considered includes the following:
...
- functional scope for tokenized wealth products;
...
| --- | --- | --- |
| IR-01 | End-to-end lifecycle support for tokenized wealth products, including initiation, approval, issuance/origination, servicing, reporting, exception handling, and closure. | Narrative |
...
| IR-20 | Approach for a future-state roadmap aligned to OCBC strategic direction, while clearly distinguishing live capability from roadmap-only functionality. | Narrative |
...
Respondents shall explain how their solution and delivery model align with the relevant legal and supervisory environment for Singapore, including **MAS, FAA, TRM Guidelines**. The institution is interested not only in headline compliance statements but in the practical machinery behind them: approval controls, audit trails, data governance, resilience practices, third-party oversight, evidence production, and governance over configuration or smart-contract change.
...
|---|---|---|
| Strategic relevance to target use case | 20% | Degree to which the response addresses tokenized wealth products specifically in the context of OCBC and Singapore. |
...
The institution expects respondents to show awareness of market developments such as **Project Guardian**, but it does not require respondents to have participated directly in those programmes. What matters is whether the respondent can connect market learning to a credible control and operating model for tokenized wealth products in Singapore.
...
The institution requests more detailed information on how respondents design and support the business-as-usual operating model for tokenized wealth products. Responses should describe first-line operations, exception management, user and participant support, control monitoring, reconciliation sign-off, reporting production, and escalation into compliance, risk, legal, or technology teams. OCBC wants to understand whether respondents have a repeatable institutional model or whether every deployment still depends on a handful of specialist engineers hovering in the background.
...
If this market-sounding exercise progresses, OCBC expects follow-up workshops to probe three things in much greater depth. First, how the proposed platform would be governed once the novelty wears off and tokenized wealth products becomes part of ordinary operating rhythm in Singapore. Second, how the solution behaves when dependencies fail, policies change, or control functions impose restrictions on short notice. Third, how the respondent helps a regulated institution preserve evidence, maintain documentation, and expand scope without turning every new requirement into a bespoke engineering exercise.
