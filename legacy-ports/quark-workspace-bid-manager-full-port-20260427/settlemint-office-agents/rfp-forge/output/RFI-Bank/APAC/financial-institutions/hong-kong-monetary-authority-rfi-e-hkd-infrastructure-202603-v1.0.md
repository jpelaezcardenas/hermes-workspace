...
| Information request theme | E-Hkd Infrastructure |
| Reference | HONG-KONG-MONETARY-AUTHORITY-RFI-202603 |
| Version | v1.0 |
...
Hong Kong Monetary Authority is conducting a structured market-sounding exercise in relation to **e-hkd infrastructure**. This Request for Information is issued for information-gathering purposes only. It does **not** constitute a commitment to procure, a binding tender, or an obligation to issue a subsequent RFP. That said, the institution is not looking for airy thought leadership either. It wants grounded information that can support internal option analysis, control design, sequencing decisions, and eventual investment cases.

The institution is seeking to understand current market maturity, viable operating models, regulatory implications, integration patterns, and delivery risks relevant to the target use case in Hong Kong. Publicly visible market material reviewed during pre-RFI shaping suggests that the environment around Hong Kong Monetary Authority is being shaped by e-HKD pilot, Project Ensemble, tokenized deposit and interbank settlement exploration. Directional research considered includes the following:



The institution has also reviewed public executive and governance signals, because successful programmes in this area live or die on sponsorship alignment, risk ownership, and operational accountability. In practical terms, senior sponsorship is likely to sit across fintech facilitation, payments, and banking supervision leadership Publicly visible references reviewed include:
...
- functional scope for e-hkd infrastructure;
...
| --- | --- | --- |
| IR-01 | End-to-end lifecycle support for e-hkd infrastructure, including initiation, approval, issuance/origination, servicing, reporting, exception handling, and closure. | Narrative |
...
| IR-04 | Alignment with HKMA supervisory expectations, SFC virtual asset and tokenized product guidance, PDPO, cyber resilience framework, e-HKD and Project Ensemble related supervisory learnings including audit evidence and control mapping. | Narrative + control mapping |
...
| IR-13 | Integration approach for institution-specific infrastructure, including ERP/GL, treasury, CRM, case management, observability stack, and domestic payment or market infrastructure in Hong Kong. | Attachment |
...
| IR-20 | Approach for a future-state roadmap aligned to Hong Kong Monetary Authority strategic direction, while clearly distinguishing live capability from roadmap-only functionality. | Narrative |
...
Respondents shall explain how their solution and delivery model align with the relevant legal and supervisory environment for Hong Kong, including **HKMA, SFC coordination, PDPO Hong Kong**. The institution is interested not only in headline compliance statements but in the practical machinery behind them: approval controls, audit trails, data governance, resilience practices, third-party oversight, evidence production, and governance over configuration or smart-contract change.
...
|---|---|---|
| Strategic relevance to target use case | 20% | Degree to which the response addresses e-hkd infrastructure specifically in the context of Hong Kong Monetary Authority and Hong Kong. |
...
The institution expects respondents to show awareness of market developments such as **e-HKD pilots, Project Ensemble, mBridge**, but it does not require respondents to have participated directly in those programmes. What matters is whether the respondent can connect market learning to a credible control and operating model for e-hkd infrastructure in Hong Kong.
...
The institution requests more detailed information on how respondents design and support the business-as-usual operating model for e-hkd infrastructure. Responses should describe first-line operations, exception management, user and participant support, control monitoring, reconciliation sign-off, reporting production, and escalation into compliance, risk, legal, or technology teams. Hong Kong Monetary Authority wants to understand whether respondents have a repeatable institutional model or whether every deployment still depends on a handful of specialist engineers hovering in the background.
...
The institution expects respondents to show awareness of how Hong Kong market structure affects implementation choices for e-hkd infrastructure. Please explain how local regulatory treatment, domestic infrastructure, data-location expectations, outsourcing scrutiny, and the practical role of internal control functions influence your recommended architecture and delivery model.

The response should also connect, where relevant, to market initiatives such as e-HKD pilots, Project Ensemble, mBridge. The point is not whether your firm participated directly in every initiative. The point is whether you understand what those initiatives have changed in buyer expectations around interoperability, programmability, governance, and operational transition.
...
Hong Kong Monetary Authority expects bidders and respondents to treat e-hkd infrastructure as an institutional transformation problem rather than a feature sale. The remaining evaluation emphasis will therefore fall on how convincingly the response explains governance ownership, control evidence, operational sustainability, and cross-functional decision-making in Hong Kong. Strong responses will connect platform capabilities to the practical realities of risk review, legal review, production support, change governance, user training, incident response, and long-term maintainability. Weak responses will keep speaking in abstractions and leave the hard questions to somebody else.
