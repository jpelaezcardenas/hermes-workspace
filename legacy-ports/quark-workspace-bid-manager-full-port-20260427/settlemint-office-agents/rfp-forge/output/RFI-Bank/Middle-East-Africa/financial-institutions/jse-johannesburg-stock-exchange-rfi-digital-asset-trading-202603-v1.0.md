...
| Field | Value |
| --- | --- |
| Reference | JSE-JOHANNESBURG-STOCK-EXCHANGE-RFI-DIGITAL-ASSET-TRADING-202603 |
| Version | v1.0 |
...
This RFI is intended to establish market maturity for digital asset trading and regulated market
...
digital asset trading and regulated market infrastructure, including onboarding, policy setup, role
...
| DQ-11 | Support platform-wide configuration governance, observability, and phased environment promotion. | Status label + explanation + evidence reference |
| DQ-12 | Support participant supervision, policy analytics, or sandbox/CBDC control requirements as relevant. | Status label + explanation + evidence reference |
...
platform supports multiple deployment patterns, state which one is most appropriate for JSE
Johannesburg Stock Exchange and why.
...
Describe a realistic delivery model for a programme comparable to digital asset trading and
regulated market infrastructure, covering discovery, design, configuration, integration, testing,
...
RFI responses will be reviewed for clarity, completeness, relevance to digital asset trading and
regulated market infrastructure, evidence quality, dependency transparency, and credibility of the
...
Use this appendix to make the operating reality of digital asset trading and regulated market
infrastructure clear to JSE Johannesburg Stock Exchange. The buyer is particularly interested in
...
Respondents should interpret market maturity carefully. For JSE Johannesburg Stock Exchange, the
question is not simply whether Digital Asset Trading And Regulated Market Infrastructure can be
...
In reviewing responses, JSE Johannesburg Stock Exchange will focus on how data and control travel
...
layer, or specialist subsystem for Digital Asset Trading And Regulated Market Infrastructure, and
...
scenarios. For JSE Johannesburg Stock Exchange, this includes not only implementation and
