...
# BNP Paribas — Request for Information
## Digital Bonds Issuance Capability

| Field | Value |
|-------|-------|
| **Document Reference** | BNPP-RFI-202603-02 |
| **Version** | v1.0 |
...
|---|---|---|---|---|
| BQ-01 | Describe your current capability to support digital bonds issuance capability across origination, onboarding, creation, lifecycle management, reporting, and retirement. | Narrative + status | Narrative response | Workflow diagrams or product notes |
...
| SQ-02 | Explain how your solution aligns or can be aligned with the following regulatory themes: MiCA, MiFID II, AIFMD, UCITS, DORA, GDPR, AMF doctrine and French securities law. | Narrative + status | Narrative response | Compliance mapping |
