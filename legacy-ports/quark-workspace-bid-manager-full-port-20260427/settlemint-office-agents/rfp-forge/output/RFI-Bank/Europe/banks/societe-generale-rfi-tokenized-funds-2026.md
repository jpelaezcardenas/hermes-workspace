...
country: France
document-type: rfi
asset-class: tokenized-funds
date: 2026-03-14
version: v1.0
reference: SG-2026-002
---

# Request for Information: Tokenized Fund Platform and Market Capability Assessment

## Section 1: Context, Scope, and Timeline

### 1.1 Issuing Organization
Société Générale operates one of the more mature digital securities initiatives in continental Europe through its regulated digital asset activities and prior work on OFH, structured products and the FORGE platform. The Group operates across universal banking, securities services and capital markets activities under French and EU prudential supervision, including oversight from the ACPR, AMF, ECB and applicable ESMA guidance. We are seeking to industrialise the next phase of our digital issuance and servicing stack rather than run isolated proof-of-concept workflows. Key drivers include reducing issuance lead time for wholesale debt instruments, improving distribution and transfer transparency, supporting programmable settlement controls, and preparing for scaled tokenized fund servicing alongside traditional registrar, paying agent and custody operating models. Our target state is an enterprise-grade platform supporting controlled issuance, lifecycle servicing and reporting for eligible digital securities under a strong governance framework.
...
Relevant frameworks include the EU DLT Pilot Regime where applicable, MiFID II / MiFIR, CSDR interfaces, Prospectus Regulation obligations, AML/CFT obligations under French and EU law, GDPR, DORA, NIS2, eIDAS for signing and evidence, and ECB/ACPR expectations on operational resilience and outsourcing. Responses should explicitly indicate how controls would map to French and EU supervisory expectations.

### 1.2 Scope and Key Scenarios
This RFI is exploratory and seeks market input on platforms that can support tokenized fund structures for French and Luxembourg distribution contexts. We are interested in capabilities for transfer agency integration, NAV publication workflows, subscription/redemption orchestration, share class controls, whitelisting, investor eligibility rules, omnibus and direct holding models, and interoperability with existing fund accounting and depositary arrangements.
...
| --- | --- | --- |
| SG-B1 | Support controlled creation, approval and release of the target asset lifecycle with configurable maker-checker controls. | Mandatory |
| SG-B2 | Provide investor or participant eligibility rules aligned to jurisdiction, product and distribution constraints. | Mandatory |
| SG-B3 | Support lifecycle servicing events including distributions, redemptions, transfers, amendments and exceptions. | Mandatory |
| SG-B4 | Provide operational dashboards, exception queues and status tracking for front-to-back teams. | Scored |
| SG-B5 | Support configurable metadata and document linkage for legal, operational and reporting artefacts. | Scored |
| SG-B6 | Enable scenario-based simulation or test workflows before production release of new products. | Desirable |
...
| ID | Requirement description | Priority |
| --- | --- | --- |
| SG-T1 | Expose documented APIs and event interfaces suitable for enterprise integration and automation. | Mandatory |
| SG-T2 | Support deployment patterns compatible with bank-controlled hosting and segregated environments. | Mandatory |
| SG-T3 | Provide comprehensive audit logs, configuration history and environment-specific controls. | Mandatory |
| SG-T4 | Support integration with IAM, key management, monitoring and enterprise workflow tooling. | Scored |
| SG-T5 | Provide non-functional evidence for scalability, resilience and performance under peak event loads. | Scored |
| SG-T6 | Offer migration tooling for reference data, positions, static data or configuration baselines. | Desirable |

Expected integration points include capital markets booking systems, issuer services workflows, KYC/AML platforms, investor eligibility services, custody and safekeeping records, payment engines, SWIFT / ISO 20022 messaging gateways, treasury systems, data warehouses, SIEM tooling and document management repositories used for deal documentation and audit evidence. Where third-party managed components are required, respondents must specify which party operates them, how incidents are handled, and what evidence can be supplied to satisfy internal security review and outsourcing governance.
...
| ID | Requirement description | Priority |
| --- | --- | --- |
| SG-S1 | Support role-based access control, least privilege and segregation of duties across administration and operations. | Mandatory |
| SG-S2 | Provide immutable or tamper-evident audit evidence for critical actions and lifecycle events. | Mandatory |
| SG-S3 | Support data residency, retention and deletion controls aligned to GDPR and local obligations. | Mandatory |
| SG-S4 | Support security monitoring, incident investigation and evidence export to bank SOC tooling. | Scored |
| SG-S5 | Demonstrate operational resilience and third-party risk controls consistent with DORA or equivalent expectations. | Scored |
| SG-S6 | Provide independent assurance artefacts and vulnerability-management processes. | Desirable |

Relevant frameworks include the EU DLT Pilot Regime where applicable, MiFID II / MiFIR, CSDR interfaces, Prospectus Regulation obligations, AML/CFT obligations under French and EU law, GDPR, DORA, NIS2, eIDAS for signing and evidence, and ECB/ACPR expectations on operational resilience and outsourcing. Responses should explicitly indicate how controls would map to French and EU supervisory expectations. Respondents should disclose any known control gaps, roadmap dependencies or jurisdictional limitations. Evidence such as certifications, assurance reports, penetration testing summaries and secure development lifecycle documentation may be attached as appendices.
...
We expect a vendor able to support Paris time-zone operations with clearly defined incident management, release governance, test and production segregation, runbooks for coupon and maturity events, and structured training for operations, technology, compliance and internal audit stakeholders. Respondents shall indicate the level of support available during critical events such as issuance dates, payment windows, maturity events, period-end reporting or contingency recovery exercises. Documentation must be suitable for business users, support teams, architects, security reviewers and auditors.
...
Société Générale expects bidders to anchor their response in the buyer's actual strategic posture rather than reuse a generic tokenization template. Société Générale, especially through SG-FORGE, is one of Europe’s most active institutional digital asset programs, with public work across tokenized bonds, fund structures, repo experimentation and an institutional euro stablecoin. A realistic procurement document for Société Générale should assume the bank already understands the category deeply and wants vendor responses grounded in production control, interoperability and regulated scale. In practical terms, that means the proposed platform must support fund tokenization, transfer-agency processes, subscriptions, redemptions, NAV-related workflows, investor restrictions and distributor connectivity while fitting into capital markets issuance and servicing, custody, payment and cash systems, smart-contract governance, investor onboarding, security operations and regulatory reporting. The bank or fintech will not score a response well if the digital-asset layer becomes a sidecar disconnected from existing books and records, operations controls, treasury workflows, or regulator-facing reporting.

The issuing team also expects bidders to recognize the buyer's governance model. SG-FORGE leadership, CIB digital assets, operations, legal, cyber and risk stakeholders would all shape evaluation. This has two consequences. First, proposals must explain how the platform supports board-level oversight, architecture review, risk sign-off and third-party control testing before production launch. Second, vendors must show how implementation can proceed without creating a long tail of manual exceptions that move risk into operations rather than remove it.

From a procurement standpoint, Société Générale will score heavily on product maturity, legal certainty, smart-contract governance and the ability to support institutional-grade issuance and servicing without manual workaround. Proposals should therefore describe not just target-state functionality but also the migration path from current-state processes, including coexistence with legacy systems, phased onboarding of products or jurisdictions, and rollback or containment measures if external dependencies fail.

### Regulatory and Jurisdictional Context
The regulatory perimeter for this procurement is shaped by ACPR, AMF, ECB supervision, MiCA, DORA and French digital-asset licensing expectations. Where the proposed operating model involves crypto-asset issuance, trading, custody, settlement or payment functionality in the EEA, respondents must explain how MiCA obligations are allocated across the buyer, the platform provider and any custody, exchange, wallet, payment or reserve-management partners. The buyer does not want hand-waving about regulatory coverage; it wants a control map that identifies which legal and operational obligations remain with the institution and which are facilitated by the proposed platform.
...
For this procurement, bidders should assume that the first live use cases will be concrete rather than experimental. At minimum, the target operating model should support fund tokenization, transfer-agency processes, subscriptions, redemptions, NAV-related workflows, investor restrictions and distributor connectivity. The proposed platform should show how configuration, approvals, ledger updates, settlement instructions, exception handling and reporting are orchestrated across those use cases without requiring brittle one-off customization for each product or jurisdiction.
...
The solution must interoperate cleanly with the buyer's established control estate. That includes capital markets issuance and servicing, custody, payment and cash systems, smart-contract governance, investor onboarding, security operations and regulatory reporting. Vendors should describe canonical data models, API contracts, event-taxonomy design, idempotency controls, batch and streaming interfaces, and how reconciliation breaks are surfaced and resolved. If the proposed platform maintains its own ledger, respondents must explain how golden-source boundaries are defined and how downstream finance, risk and regulatory systems consume authoritative records.
...
Because this is an RFI rather than a committed award process, Société Générale is using this document to separate productized platforms from ambitious slide decks. Respondents should therefore describe the maturity of their solution for fund tokenization, transfer-agency processes, subscriptions, redemptions, NAV-related workflows, investor restrictions and distributor connectivity in very concrete terms: what is live today, what is in pilot, what is customer-specific, and what remains roadmap. The buyer is especially interested in evidence that a platform can survive production governance, exception volume, regulator scrutiny and multi-team operating ownership.
