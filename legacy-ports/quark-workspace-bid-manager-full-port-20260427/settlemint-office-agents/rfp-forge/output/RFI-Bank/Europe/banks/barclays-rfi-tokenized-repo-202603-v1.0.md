...
# Barclays — Request for Information
## Tokenized Repo Capability

| Field | Value |
|-------|-------|
| **Document Reference** | BARC-RFI-202603-05 |
| **Version** | v1.0 |
...
|---|---|---|---|---|
| BQ-01 | Describe your current capability to support tokenized repo capability across origination, onboarding, creation, lifecycle management, reporting, and retirement. | Narrative + status | Narrative response | Workflow diagrams or product notes |
...
| SQ-02 | Explain how your solution aligns or can be aligned with the following regulatory themes: UK FCA rules, PRA outsourcing and operational resilience expectations, MiFID II where relevant, UK GDPR, CSDR where EU market connectivity is in scope, DORA for EU interactions. | Narrative + status | Narrative response | Compliance mapping |
