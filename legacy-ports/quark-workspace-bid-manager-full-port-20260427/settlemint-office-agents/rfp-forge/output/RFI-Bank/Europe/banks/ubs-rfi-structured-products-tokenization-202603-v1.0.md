...
# UBS — Request for Information
## Structured Products Tokenization Capability

| Field | Value |
|-------|-------|
| **Document Reference** | UBS-RFI-202603-03 |
| **Version** | v1.0 |
...
|---|---|---|---|---|
| BQ-01 | Describe your current capability to support structured products tokenization capability across origination, onboarding, creation, lifecycle management, reporting, and retirement. | Narrative + status | Narrative response | Workflow diagrams or product notes |
