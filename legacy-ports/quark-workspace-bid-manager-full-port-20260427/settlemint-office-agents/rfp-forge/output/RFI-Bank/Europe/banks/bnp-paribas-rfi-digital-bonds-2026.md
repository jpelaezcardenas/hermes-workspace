...
date: 2026-03-14
version: v1.0
reference: BNPP-2026-002
---

# Request for Information: Digital Bonds Market Sounding
...
This RFI concerns digital bonds as the primary asset class. The Bank is seeking structured market information and does not intend this document to create any binding procurement obligation, shortlist commitment or volume commitment. The in-scope scenarios include Exploratory review of digital bond issuance, servicing and settlement capabilities across primary issuance, private placements and selected structured debt scenarios. This RFI is intended for market discovery only.
...
Because this is an RFI rather than a committed award process, BNP Paribas is using this document to separate productized platforms from ambitious slide decks. Respondents should therefore describe the maturity of their solution for bond issuance, bookbuilding support, investor onboarding, settlement, coupon processing, redemption and issuer reporting in very concrete terms: what is live today, what is in pilot, what is customer-specific, and what remains roadmap. The buyer is especially interested in evidence that a platform can survive production governance, exception volume, regulator scrutiny and multi-team operating ownership.
