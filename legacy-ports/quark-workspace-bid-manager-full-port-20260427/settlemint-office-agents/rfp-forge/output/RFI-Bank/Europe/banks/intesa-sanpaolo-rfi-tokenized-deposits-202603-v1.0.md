...
# Intesa Sanpaolo — Request for Information
## Tokenized Deposits Capability

| Field | Value |
|-------|-------|
| **Document Reference** | ISP-RFI-202603-08 |
| **Version** | v1.0 |
...
|---|---|---|---|---|
| BQ-01 | Describe your current capability to support tokenized deposits capability across origination, onboarding, creation, lifecycle management, reporting, and retirement. | Narrative + status | Narrative response | Workflow diagrams or product notes |
...
| SQ-02 | Explain how your solution aligns or can be aligned with the following regulatory themes: MiCA, MiFID II, Italian securities and banking law, CONSOB and Bank of Italy expectations, DORA, GDPR. | Narrative + status | Narrative response | Compliance mapping |
