...
# KfW — Request for Information
## Tokenized Infrastructure Capability

| Field | Value |
|-------|-------|
| **Document Reference** | KFW-RFI-202603-12 |
| **Version** | v1.0 |
...
|---|---|---|---|---|
| BQ-01 | Describe your current capability to support tokenized infrastructure capability across origination, onboarding, creation, lifecycle management, reporting, and retirement. | Narrative + status | Narrative response | Workflow diagrams or product notes |
...
| SQ-02 | Explain how your solution aligns or can be aligned with the following regulatory themes: MiCA, MiFID II, German eWpG, public procurement and public-sector audit requirements, DORA, GDPR, BaFin guidance. | Narrative + status | Narrative response | Compliance mapping |
