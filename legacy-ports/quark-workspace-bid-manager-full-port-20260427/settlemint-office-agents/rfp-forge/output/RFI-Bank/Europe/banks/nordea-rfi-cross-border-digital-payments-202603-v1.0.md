...
# Nordea — Request for Information
## Cross-Border Digital Payments Capability

| Field | Value |
|-------|-------|
| **Document Reference** | NORDEA-RFI-202603-09 |
| **Version** | v1.0 |
...
|---|---|---|---|---|
| BQ-01 | Describe your current capability to support cross-border digital payments capability across origination, onboarding, creation, lifecycle management, reporting, and retirement. | Narrative + status | Narrative response | Workflow diagrams or product notes |
...
| SQ-02 | Explain how your solution aligns or can be aligned with the following regulatory themes: MiCA, MiFID II, UCITS, AIFMD, DORA, GDPR, Nordic supervisory expectations. | Narrative + status | Narrative response | Compliance mapping |
