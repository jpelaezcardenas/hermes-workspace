# Request for Information (RFI): Digital Collateral Management

| Field | Value |
| --- | --- |
| Reference number | EUREX-RFI-202603 |
| Version | v1.0 |
...
The buyer operates within a control perimeter shaped by BaFin, Deutsche Bundesbank, ESMA where relevant, and ECB supervisory interfaces where applicable. Responses must therefore address how the offering would fit within the buyer’s oversight, security, audit, and data-governance expectations. A response that simply states “we are compliant” without mapping the relevant controls, evidence sources, and operating assumptions will be treated as weak.
