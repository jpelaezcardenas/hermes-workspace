# Bank of Canada — Request for Proposal
...
| Document Reference | BANK-OF-CANA-RFP-202603-10 |
| Document Type | RFP |
...
| Workstream 2 | Configuration of the platform for digital currency pilot infrastructure for controlled experimentation, including product templates, token or asset models, workflow approvals, entitlement structures, reporting schemas, data retention rules and control checkpoints. |
...
| FR-10 | Support phased rollout by entity, geography, participant segment, product or workflow while preserving shared control patterns for digital currency pilot infrastructure for controlled experimentation. | Mandatory | Narrative + evidence | Rollout plan / tenancy model |
...
| FR-13 | Support integration patterns specific to the buyer environment, including wholesale payment infrastructure, policy research environments, participant access controls, settlement simulations and strict segregation from production payment systems. | Mandatory | Narrative + evidence | Target-state integration blueprint |
...
|---|---|---|
| Functional fit and workflow coverage | 22% | Alignment to the target operating model for digital currency pilot infrastructure for controlled experimentation and realism of end-to-end lifecycle coverage |
...
|---|---|
| Internal systems | wholesale payment infrastructure, policy research environments, participant access controls, settlement simulations and strict segregation from production payment systems. |
...
The bidder shall also address operational compliance design for digital currency pilot infrastructure for controlled experimentation. This includes wholesale participant eligibility, settlement finality controls, policy overlays, reconciliation to authoritative ledgers and supervisory evidence. Where the regulatory perimeter depends on business structure, the bidder shall present configurable options together with the residual responsibilities that remain with Bank of Canada. Responses must identify what evidence is generated natively, what is derived via integration, how timestamps are normalised across components, and how legal-entity, desk or participant segmentation is preserved in both the live operating model and archived records.
...
The following scenarios are intended to test whether the proposed platform can keep Bank of Canada's control environment intact while supporting digital currency pilot infrastructure for controlled experimentation. Respondents shall describe native product behaviour, configuration points, integration dependencies, operational ownership, evidence outputs and fallback procedures for each scenario.
...
For avoidance of doubt, Bank of Canada will treat unanswered delivery-risk questions as a material weakness even where the product appears functionally strong. The bidder should therefore identify non-standard assumptions, unresolved third-party dependencies, minimum-volume thresholds, jurisdictional constraints, roadmap items, implementation accelerators that require buyer resources, and any feature areas where manual controls remain necessary for digital currency pilot infrastructure for controlled experimentation. This clarification section should also state what the buyer must provide to keep timeline, budget and control outcomes realistic.
