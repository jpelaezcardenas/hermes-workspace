# Citigroup — Request for Proposal
...
| Document Reference | CITIGROUP-RFP-202603-03 |
| Document Type | RFP |
...
| Workstream 2 | Configuration of the platform for cross-border tokenized payments for treasury and commercial flows, including product templates, token or asset models, workflow approvals, entitlement structures, reporting schemas, data retention rules and control checkpoints. |
...
| FR-10 | Support phased rollout by entity, geography, participant segment, product or workflow while preserving shared control patterns for cross-border tokenized payments for treasury and commercial flows. | Mandatory | Narrative + evidence | Rollout plan / tenancy model |
...
| FR-13 | Support integration patterns specific to the buyer environment, including Citi Token Services adjacent cash-management rails, Treasury and Trade Solutions workflows, sanctions screening, SWIFT connectivity, ERP connectors, liquidity management systems and enterprise risk tooling. | Mandatory | Narrative + evidence | Target-state integration blueprint |
...
|---|---|---|
| Functional fit and workflow coverage | 22% | Alignment to the target operating model for cross-border tokenized payments for treasury and commercial flows and realism of end-to-end lifecycle coverage |
...
|---|---|
| Internal systems | Citi Token Services adjacent cash-management rails, Treasury and Trade Solutions workflows, sanctions screening, SWIFT connectivity, ERP connectors, liquidity management systems and enterprise risk tooling. |
...
The following scenarios are intended to test whether the proposed platform can keep Citigroup's control environment intact while supporting cross-border tokenized payments for treasury and commercial flows. Respondents shall describe native product behaviour, configuration points, integration dependencies, operational ownership, evidence outputs and fallback procedures for each scenario.
...
For avoidance of doubt, Citigroup will treat unanswered delivery-risk questions as a material weakness even where the product appears functionally strong. The bidder should therefore identify non-standard assumptions, unresolved third-party dependencies, minimum-volume thresholds, jurisdictional constraints, roadmap items, implementation accelerators that require buyer resources, and any feature areas where manual controls remain necessary for cross-border tokenized payments for treasury and commercial flows. This clarification section should also state what the buyer must provide to keep timeline, budget and control outcomes realistic.
