...
| Institution | ANZ |
| Region | APAC |
| Country / market | Australia |
| Procurement theme | Tokenized Commodity Finance |
| Reference | ANZ-RFP-202603 |
| Version | v1.0 |
| Issue month | March 2026 |
| Indicative currency | AUD |
| Primary regulatory context | APRA, ASIC, RBA policy expectations |
| Relevant market initiatives | Project Guardian, ANZ Australian dollar stablecoin programme |
| Classification | Confidential – invited bidders only |

## 1. Procurement Context

ANZ is issuing this Request for Proposal to identify a qualified technology provider and implementation partner for a regulated **tokenized commodity finance** programme in Australia. This is not a beauty parade and it is not an invitation to recycle a generic digital-asset deck. The institution expects bidders to respond as if the programme will be scrutinised by risk, internal audit, cyber security, legal, compliance, operations, and senior management from day one. Production readiness, governance clarity, and the ability to survive boring operational reality matter more than glossy pilot language.

The procurement context is informed by publicly visible market activity around A$DC stablecoin work, Chainlink-related tokenized asset experiments, cross-border commodities financing digitisation. Market signals reviewed during pre-procurement analysis indicate that ANZ operates in an environment where digital asset initiatives are moving from exploratory proof points toward controlled institutional deployment. Recent public material reviewed by the institution includes the following directional intelligence:

- The role of tokenisation in cross-border transactions | ANZ: At ANZ , we believe in the transformative benefits of digital assets . Over the past three years, we've been exploring how tokenisation - the process of representing an asset , or the ownership rights of an asset , as a digital token on blockchain or other decentralised network - can improve the way we meet our customers' needs as they move ...
- ANZ Partners With Chainlink Labs, Joins Project Guardian To Advance ...: Today, Australia and New Zealand Banking Group Limited ( ANZ ), a leading Australian bank with over 1 trillion AUD in assets under management, announced it has officially partnered with Chainlink Labs and joined the Monetary Authority of Singapore's Project Guardian, a multi-year collaboration between policymakers and the financial industry to enhance financial markets' liquidity and ...
- Australian bank joins Project Guardian to explore RWA tokenization: Australian bank ANZ has joined the Monetary Authority of Singapore's Project Guardian to explore how it can move RWAs on blockchains .
- ANZ Partners with Chainlink to Pioneer Asset Tokenization in Project ...: ANZ collaborates with Chainlink Labs and ADDX to explore tokenization of real-world assets in financial markets. Project Guardian, led by MAS, aims to enhance market liquidity through the tokenization of assets .
- Australia's ANZ joins Project Guardian on tokenized assets: ANZ adopted Chainlink's cross-chain interoperability protocol to simulate tokenized asset purchases. This move followed insights from the Swift blockchain interoperability project started in June. Tokenization refers to the process of turning traditional assets , like money market funds, into digital tokens that can be used on blockchain networks.
...
- ANZ Partners With Chainlink Labs, Joins Project Guardian To Advance ...: Today, Australia and New Zealand Banking Group Limited ( ANZ ), a leading Australian bank with over 1 trillion AUD in assets under management, announced it has officially partnered with Chainlink Labs and joined the Monetary Authority of Singapore's Project Guardian, a multi-year collaboration between policymakers and the financial industry to enhance financial markets' liquidity and ...
- The role of tokenisation in cross-border transactions | ANZ: At ANZ , we believe in the transformative benefits of digital assets . Over the past three years, we've been exploring how tokenisation - the process of representing an asset , or the ownership rights of an asset , as a digital token on blockchain or other decentralised network - can improve the way we meet our customers' needs as they move ...
- The invisible engine of banking's future | ANZ: The rise of digital assets has helped reshape the financial system in recent years. But application of the underlying blockchain technology is yet to reach its full potential - one which could see it serve as the "invisible engine" driving all financial services. That's the view of ANZ Manager Industry and Innovation Cindy He, who told ANZ Institutional on podcast she thinks the ...
- Australian lender ANZ partners with Chainlink to explore RWA tokenization: Australia's ANZ Bank partners with Chainlink Labs and ADDX to explore tokenized assets for Singapore's Project Guardian.
- Australia's ANZ Bank Takes Bold Step into RWA Tokenization with Project ...: ANZ , one of Australia's largest banks, is working with blockchain oracle provider Chainlink Labs and investment firm ADDX to examine how assets like commercial papers can be tokenized and transferred across multiple blockchains . .
...
- establish a controlled and reusable operating model for tokenized commodity finance that can move from pilot scope to business-as-usual operations without a re-platform;
...
- ensure regulatory and audit readiness in line with APRA, ASIC, RBA policy expectations;
...
- position ANZ to participate credibly in market initiatives connected to Project Guardian, ANZ Australian dollar stablecoin programme without creating stranded technology or governance debt.
...
- institution-specific context matters: responses must show an understanding of Australia market structure, operating constraints, and the programme relevance of Project Guardian, ANZ Australian dollar stablecoin programme;
...
The selected vendor shall provide software, implementation services, configuration support, documentation, training, and transition assistance required to establish a production-ready tokenized commodity finance environment. The scope includes business workflows, technical architecture, controls, integration services, operational tooling, support arrangements, and the artefacts necessary for audit and risk sign-off.
...
Respondents should assume integration into the institution's existing enterprise landscape, including finance ledgers, payment and settlement systems, data warehouses or lakes, risk and compliance tooling, identity and access management, and service management / observability platforms. For ANZ, the integration pattern must also reflect current modernization priorities around tokenized commodity finance and the public-market direction signalled through Project Guardian, ANZ Australian dollar stablecoin programme.

### 2.2 Technical requirements table

| Req ID | Requirement | Priority | Response Type | Evaluation Notes |
| --- | --- | --- | --- | --- |
| TR-01 | End-to-end lifecycle support for tokenized commodity finance, including initiation, approval, issuance/origination, servicing, reporting, exception handling, and closure. | Must | Comply with narrative | Institution expects lifecycle completeness, not a narrow pilot demo. |
...
| TR-04 | Alignment with ASIC and APRA expectations, CPS 230 operational risk management, CPS 234 information security, AML/CTF Act, RBA payment and settlement oversight including audit evidence and control mapping. | Must | Narrative + control mapping | Regulatory fit is a board-level issue. |
...
| TR-13 | Integration approach for institution-specific infrastructure, including ERP/GL, treasury, CRM, case management, observability stack, and domestic payment or market infrastructure in Australia. | Must | Attachment | The institution expects a realistic connectivity plan. |
...
| TR-20 | Approach for a future-state roadmap aligned to ANZ strategic direction, while clearly distinguishing live capability from roadmap-only functionality. | Should | Narrative | No hand-wavy roadmap theatre. |
...
The proposed solution shall align with the legal, supervisory, and risk-management expectations applicable to Australia. At minimum, respondents must describe how their offering supports requirements arising under **APRA, ASIC, RBA policy expectations**. Where the proposed architecture spans multiple jurisdictions, the respondent shall distinguish domestic controls from cross-border controls and identify any legal, licensing, tax, sanctions, or data-transfer assumptions.
...
| --- | --- | --- |
| Strategic and use-case fit | 18% | Depth of alignment to ANZ's stated objectives in tokenized commodity finance, including realism of business case, target operating model, and phased execution approach. |
...
| Security, regulatory, and control maturity | 17% | Alignment to APRA, ASIC, RBA policy expectations, auditability, change control, data governance, and cyber posture. |
...
- executive summary and solution overview tailored to ANZ and tokenized commodity finance;
...
The institution requires bidders to describe a security architecture appropriate for high-trust regulated environments. Responses should cover identity federation, privileged access management, device or session controls for administrators, key management and HSM/KMS integration, certificate lifecycle management, vulnerability management, patching cadence, code-signing, configuration hardening, logging integrity, and alerting thresholds. For tokenized commodity finance, the institution is especially concerned with how administrative override events are controlled, evidenced, and independently reviewable.
...
Responses should further address cyber-resilience expectations relevant to Australia, including alignment with APRA, ASIC, RBA policy expectations. Vendors should describe secure software development practices, penetration testing scope and frequency, independent assurance results, backup encryption, immutable logging options, evidence retention, and post-incident review workflows. The winning bidder will need to support scrutiny not only from security teams but also from risk committees, audit functions, and external regulators or supervisors.

### Appendix K – Data, reporting, and audit evidence expectations

A recurring failure mode in digital-asset programmes is that transaction workflows are built first and reporting is improvised later. ANZ is explicitly trying to avoid that mistake. Respondents shall therefore describe how the platform captures, stores, enriches, reconciles, and exports operational data, accounting data, and control evidence across the full lifecycle of tokenized commodity finance. The institution expects support for event lineage, field-level traceability, time synchronization, report reproducibility, and controlled data retention.
...
Responses should demonstrate clear awareness of how Australia market structure affects solution design for tokenized commodity finance. That includes the interplay between local regulatory expectations, domestic payment or settlement infrastructure, data location constraints, outsourcing scrutiny, and the practical role of internal control functions. Bidders should discuss how their platform and delivery model align with APRA, ASIC, RBA policy expectations, and how those obligations affect deployment choices, access controls, resilience design, evidence retention, and third-party contracting.

The institution also expects respondents to connect their answer to the market initiatives most relevant to this procurement, namely Project Guardian, ANZ Australian dollar stablecoin programme. The goal is not to repeat press releases. The goal is to show that the bidder understands how those initiatives influence buyer expectations around interoperability, programmability, governance, and production transition. Where the vendor believes a market initiative is not directly relevant, it should say so and explain why.
...
Cutover planning must include go/no-go criteria, command structure, decision rights, communications, backout triggers, manual contingency procedures, and post-cutover observation periods. Respondents should set out how reconciliation will be validated on day one, how open exceptions will be triaged, how access will be controlled during the high-risk cutover window, and how business, risk, compliance, and technology stakeholders will be kept aligned. Because ANZ operates in a regulated environment, cutover is not merely a technical switch; it is a controlled business event that must withstand retrospective scrutiny.
...
Bidders should also address future-state scenarios. Examples include expansion to new legal entities, new business lines, more counterparties, additional jurisdictions, or broader participation in initiatives related to Project Guardian, ANZ Australian dollar stablecoin programme. The institution wants to understand whether the proposed architecture can scale through configuration and governed rollout, or whether each expansion will trigger a mini reimplementation. A scalable answer will discuss parameterization, reusable templates, tenant or entity isolation, policy inheritance, and structured approval workflows for new product variants.
...
Ninth, bidders should explain how future roadmap items are governed. ANZ does not object to roadmaps; every serious platform has one. What matters is whether roadmap items are separated cleanly from committed deliverables, how client influence is handled, how security and regulatory implications are reviewed before release, and how backwards compatibility is managed. The institution does not want a strategic dependency on promises that are still floating around a product meeting somewhere.
