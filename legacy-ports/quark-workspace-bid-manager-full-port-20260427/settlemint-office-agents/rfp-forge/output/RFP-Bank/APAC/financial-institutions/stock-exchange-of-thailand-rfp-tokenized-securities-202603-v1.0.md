...
| Institution | Stock Exchange of Thailand |
| Region | APAC |
| Country / market | Thailand |
| Procurement theme | Tokenized Securities |
| Reference | STOCK-EXCHANGE-OF-THAILAND-RFP-202603 |
| Version | v1.0 |
| Issue month | March 2026 |
| Indicative currency | THB |
| Primary regulatory context | SEC Thailand, Bank of Thailand, PDPA Thailand |
| Relevant market initiatives | Thai digital asset exchange infrastructure learnings |
| Classification | Confidential – invited bidders only |

## 1. Procurement Context

Stock Exchange of Thailand is issuing this Request for Proposal to identify a qualified technology provider and implementation partner for a regulated **tokenized securities** programme in Thailand. This is not a beauty parade and it is not an invitation to recycle a generic digital-asset deck. The institution expects bidders to respond as if the programme will be scrutinised by risk, internal audit, cyber security, legal, compliance, operations, and senior management from day one. Production readiness, governance clarity, and the ability to survive boring operational reality matter more than glossy pilot language.

The procurement context is informed by publicly visible market activity around digital asset exchange adjacency, Thai capital markets digitisation, local investor protection constraints. Market signals reviewed during pre-procurement analysis indicate that Stock Exchange of Thailand operates in an environment where digital asset initiatives are moving from exploratory proof points toward controlled institutional deployment. Recent public material reviewed by the institution includes the following directional intelligence:
...
- ensure regulatory and audit readiness in line with SEC Thailand, Bank of Thailand, PDPA Thailand;
...
- position Stock Exchange of Thailand to participate credibly in market initiatives connected to Thai digital asset exchange infrastructure learnings without creating stranded technology or governance debt.
...
- institution-specific context matters: responses must show an understanding of Thailand market structure, operating constraints, and the programme relevance of Thai digital asset exchange infrastructure learnings;
...
Respondents should assume integration into the institution's existing enterprise landscape, including finance ledgers, payment and settlement systems, data warehouses or lakes, risk and compliance tooling, identity and access management, and service management / observability platforms. For Stock Exchange of Thailand, the integration pattern must also reflect current modernization priorities around tokenized securities and the public-market direction signalled through Thai digital asset exchange infrastructure learnings.
...
| TR-20 | Approach for a future-state roadmap aligned to Stock Exchange of Thailand strategic direction, while clearly distinguishing live capability from roadmap-only functionality. | Should | Narrative | No hand-wavy roadmap theatre. |
...
| --- | --- | --- |
| Strategic and use-case fit | 18% | Depth of alignment to Stock Exchange of Thailand's stated objectives in tokenized securities, including realism of business case, target operating model, and phased execution approach. |
...
| Security, regulatory, and control maturity | 17% | Alignment to SEC Thailand, Bank of Thailand, PDPA Thailand, auditability, change control, data governance, and cyber posture. |
...
- executive summary and solution overview tailored to Stock Exchange of Thailand and tokenized securities;
...
Stock Exchange of Thailand expects respondents to describe, in detail, how their platform would handle tokenized securities under real production conditions in Thailand. This includes governance intake, change approval, environment promotion, release testing, participant support, exception handling, financial reconciliation, and regulator-facing evidence production. Respondents should explain who performs each task, which evidence is generated automatically, what remains manual, and what control breaks have been observed in similar deployments.
...
Responses should demonstrate clear awareness of how Thailand market structure affects solution design for tokenized securities. That includes the interplay between local regulatory expectations, domestic payment or settlement infrastructure, data location constraints, outsourcing scrutiny, and the practical role of internal control functions. Bidders should discuss how their platform and delivery model align with SEC Thailand, Bank of Thailand, PDPA Thailand, and how those obligations affect deployment choices, access controls, resilience design, evidence retention, and third-party contracting.

The institution also expects respondents to connect their answer to the market initiatives most relevant to this procurement, namely Thai digital asset exchange infrastructure learnings. The goal is not to repeat press releases. The goal is to show that the bidder understands how those initiatives influence buyer expectations around interoperability, programmability, governance, and production transition. Where the vendor believes a market initiative is not directly relevant, it should say so and explain why.
...
Cutover planning must include go/no-go criteria, command structure, decision rights, communications, backout triggers, manual contingency procedures, and post-cutover observation periods. Respondents should set out how reconciliation will be validated on day one, how open exceptions will be triaged, how access will be controlled during the high-risk cutover window, and how business, risk, compliance, and technology stakeholders will be kept aligned. Because Stock Exchange of Thailand operates in a regulated environment, cutover is not merely a technical switch; it is a controlled business event that must withstand retrospective scrutiny.
...
Bidders should also address future-state scenarios. Examples include expansion to new legal entities, new business lines, more counterparties, additional jurisdictions, or broader participation in initiatives related to Thai digital asset exchange infrastructure learnings. The institution wants to understand whether the proposed architecture can scale through configuration and governed rollout, or whether each expansion will trigger a mini reimplementation. A scalable answer will discuss parameterization, reusable templates, tenant or entity isolation, policy inheritance, and structured approval workflows for new product variants.
...
Ninth, bidders should explain how future roadmap items are governed. Stock Exchange of Thailand does not object to roadmaps; every serious platform has one. What matters is whether roadmap items are separated cleanly from committed deliverables, how client influence is handled, how security and regulatory implications are reviewed before release, and how backwards compatibility is managed. The institution does not want a strategic dependency on promises that are still floating around a product meeting somewhere.
