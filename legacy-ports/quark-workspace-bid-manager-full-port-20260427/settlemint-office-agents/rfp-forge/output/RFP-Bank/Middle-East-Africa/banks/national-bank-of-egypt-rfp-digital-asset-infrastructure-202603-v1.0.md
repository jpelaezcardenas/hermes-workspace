...
| Field | Value |
| --- | --- |
| Reference | NATIONAL-BANK-OF-EGYPT-RFP-DIGITAL-ASSET-INFRASTRUCTURE-202603 |
| Version | v1.0 |
| Issue date | March 2026 |
| Issuing organization | National Bank of Egypt (Egypt) |
| Document type | RFP |
| Subject | Digital Asset Core Infrastructure For Regulated Institutional Products |
...
National Bank of Egypt is treating digital asset core infrastructure for regulated institutional
products as a business-critical capability that must be implemented with the same discipline applied
to core regulated systems. The solution under consideration will be expected to operate inside a
control environment shaped by business ownership, architecture standards, security review, legal
...
Regional conditions in Egypt also matter. The buyer expects bidders to anchor their response in
...
The first objective is to identify a platform and supplier capable of supporting digital asset core
infrastructure for regulated institutional products in live operation, not just in a demonstration
...
The second objective is to understand the operating model implied by each response. National Bank of
Egypt needs to know which activities are automated, which are configurable, which require manual
...
| WS-02 | Business and product configuration | Configure lifecycle, roles, limits, disclosures, and policy rules for digital asset core infrastructure for regulated institutional products. |
...
wants to understand how the work actually lands inside National Bank of Egypt's organisation.
...
Three issues will dominate this procurement. First is control integrity around digital asset core
infrastructure for regulated institutional products; the buyer must be able to identify who
initiated a change or transaction, which policy checks applied, who approved the event, and how the
resulting state can be reconstructed later. Second is coexistence with existing enterprise systems;
the selected solution cannot become a reconciliation sinkhole that generates more manual work than
it removes. Third is phased scalability; the buyer wants to move from initial launch to broader
...
evidence posture are suitable for a regulated institution in Egypt. The strongest responses will be
...
Respondents must address the legal and supervisory context relevant to Egypt, including CBE
requirements, FRA obligations where capital markets activities arise, data and cybersecurity
controls, AML/CFT requirements, outsourcing governance, record retention obligations. Applicability
may differ by legal entity, product perimeter, client segment, and whether the target structure is
treated as a payment, security, custody arrangement, deposit analogue, investment product, or
supervised market activity. The bidder must therefore state its assumptions clearly rather than
implying universal applicability.
...
core infrastructure for regulated institutional products programme.
...
For National Bank of Egypt, this appendix should be written in a way that supports architecture
...
For National Bank of Egypt, operational governance for Digital Asset Core Infrastructure For
Regulated Institutional Products must define named control owners across product management, first-
line operations, compliance oversight, treasury or finance, information security, platform
...
incident review, and management reporting. National Bank of Egypt is especially interested in
...
A strong response should explain how data relating to Digital Asset Core Infrastructure For
Regulated Institutional Products moves between channels, orchestration layers, policy engines,
ledgers, books-and-records, reporting stacks, and external participants. National Bank of Egypt
expects the bidder to identify authoritative data sources, event sequencing assumptions, idempotency
treatment, reference data ownership, and how replay or recovery is handled after processing
interruptions.
...
Integration narratives should also address release management. National Bank of Egypt wants to know
...
Given the sensitivity of Digital Asset Core Infrastructure For Regulated Institutional Products, the
buyer expects layered security controls rather than a single assertion of secure design. Bidders
...
Resilience discussion should go beyond backup existence. National Bank of Egypt wants evidence of
...
configuration, interface build, testing, training, and cutover fit together. National Bank of Egypt
...
to Digital Asset Core Infrastructure For Regulated Institutional Products, the more disciplined
...
workshops, admin training, operator runbooks, and handover artifacts are provided so that National
Bank of Egypt can build internal capability rather than remain dependent on a small external
delivery team.
...
third-party services grow. National Bank of Egypt wants to know whether cost scales linearly, steps
at thresholds, or depends on discretionary supplier interpretation. A credible bid gives procurement
...
core aspects of Digital Asset Core Infrastructure For Regulated Institutional Products depend on a
...
National Bank of Egypt (Egypt) is not approaching **digital asset core infrastructure for regulated institutional products** as a generic blockchain exercise. NBE operates at national scale and any digital-asset infrastructure programme must align closely with state-led payment modernisation, capital-market digitisation, and conservative regulatory perimeter management. The most plausible path is controlled infrastructure for tokenized instruments, evidence, and settlement interfaces rather than open crypto-market access. The implication for bidders is simple: responses must explain how a controlled production programme would be governed from initial launch through scale, how policy and entitlement decisions are evidenced, and how the platform avoids creating a parallel operating stack that business, risk, and audit teams cannot actually supervise.

The buyer expects the proposed solution to align with the institution's current operating reality. Likely dependencies include CBE rails, national payment infrastructure, treasury and government-securities systems, AML controls, and large-scale citizen/corporate servicing channels. A strong response will therefore identify authoritative systems of record, describe event sequencing between the platform and adjacent enterprise systems, and explain how breaks are detected before they become unresolved ledger differences or customer-impacting incidents.

Executive sponsorship is also expected to be multidisciplinary. Government-relations, treasury, enterprise architecture, operations, risk, and cyber-security leaders are likely to dominate governance. This matters because the selected supplier will not be evaluated by innovation staff alone. It will be tested by people who care about booking-model integrity, operational resilience, information security, regulatory defensibility, and board-quality reporting.

Finally, the buyer wants commercial and sourcing realism. Expect heavy formal procurement, sovereignty concerns, Arabic reporting requirements, and strong preference for operational resilience and local control. Bidders should assume that any hidden dependency, vague implementation assumption, or roadmap-led answer will be surfaced quickly during architecture review and clarification sessions.

### 8.12 Company-specific use-case and technical depth

For National Bank of Egypt (Egypt), the most relevant workload pattern is **foundational digital-asset infrastructure, issuance controls, entitlements, reporting, and interoperability with national payments and securities infrastructure**. Bidders should therefore address at least five operating layers in detail. First, origination and onboarding: how clients, issuers, investors, counterparties, merchants, or participating institutions are onboarded; how eligibility rules are applied; how documentation is stored and versioned; and how approvals are routed when records are incomplete or contradictory. Second, lifecycle execution: how assets, payment obligations, investor entitlements, receivables, or tokenized instruments are created; which fields are configurable; which actions require human approval; and how rules differ by entity, corridor, investor class, or instrument type.
...
The regulatory perimeter for National Bank of Egypt (Egypt) is shaped by Central Bank of Egypt (CBE), Financial Regulatory Authority (FRA), Banking Law No. 194 of 2020, AML Law No. 80 of 2002, Personal Data Protection Law No. 151 of 2020, rules on dematerialized securities and capital-market activity. Bidders must not treat that list as a box-ticking reference. They need to translate the perimeter into platform behaviour: data-location choices, audit-log retention periods, approval routing, customer classification, reporting outputs, outsourcing controls, incident escalation, access recertification, and evidentiary support during supervisory review.

Where the requested use case intersects capital-markets activity, payments, custody, digital-asset exchange operations, or tokenized deposit analogues, respondents should explain the assumed legal characterisation and the resulting control posture. If a proposed architecture depends on a regulated partner, foreign booking model, special-purpose issuer, bankruptcy-remote vehicle, or external wallet/custodian, that structure must be declared explicitly together with the residual obligations that remain with National Bank of Egypt (Egypt). If Sharia governance is relevant, the bidder should explain how product rules, approval lineage, prohibited activity restrictions, and board or committee evidence are captured and reported.
...
Operational resilience is equally important. Responses should specify recovery-time and recovery-point targets, restoration testing frequency, dependency mapping, degraded-mode behaviour, and the operational plan for third-party outages, network partition, failed screening calls, stuck workflows, delayed settlement confirmations, or inconsistent state across ledgers. The strongest responses will show how National Bank of Egypt (Egypt) could take the platform through architecture review, information-security review, business-continuity review, and internal-audit walkthrough without rewriting the story for each audience.

### 8.14 Company-specific evaluation overlay

In addition to the standard scoring model already defined in this document, National Bank of Egypt (Egypt) expects evaluators to apply the following company-specific weighting overlay when distinguishing between suppliers:

| Criterion | Weight | Why it matters in this procurement |
| --- | --- | --- |
| Strategic business fit | 22% | Scored against digital asset core infrastructure for regulated institutional products in the specific context of National Bank of Egypt (Egypt). |
| Technical architecture and integration fit | 18% | Scored against digital asset core infrastructure for regulated institutional products in the specific context of National Bank of Egypt (Egypt). |
| Regulatory, compliance, and control evidence | 20% | Scored against digital asset core infrastructure for regulated institutional products in the specific context of National Bank of Egypt (Egypt). |
| Security, resilience, and operational readiness | 15% | Scored against digital asset core infrastructure for regulated institutional products in the specific context of National Bank of Egypt (Egypt). |
| Delivery credibility and partner model | 12% | Scored against digital asset core infrastructure for regulated institutional products in the specific context of National Bank of Egypt (Egypt). |
| Commercial transparency and TCO | 8% | Scored against digital asset core infrastructure for regulated institutional products in the specific context of National Bank of Egypt (Egypt). |
| Supplier viability and roadmap discipline | 5% | Scored against digital asset core infrastructure for regulated institutional products in the specific context of National Bank of Egypt (Egypt). |
...
A realistic proposal for National Bank of Egypt (Egypt) should therefore provide a phased deployment hypothesis. Phase one should describe the minimum safe production scope, the volumes and participant types supported at launch, required client-side roles, major control gates, and objective acceptance criteria. Phase two should describe how the scope expands once controls, throughput, and reporting have been proven. If the bidder believes the requested use case should be sequenced differently, that is acceptable, but the answer must still show a credible route from contained launch to scaled operations.
