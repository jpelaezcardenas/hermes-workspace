# Request for Proposal (RFP): Wholesale Cbdc Pilot Infrastructure

| Field | Value |
| --- | --- |
| Reference number | BANKOFENGLAND-RFP-202603 |
| Version | v1.0 |
| Issue date | March 2026 |
| Issuing institution | Bank of England |
| Jurisdiction | United Kingdom |
| Currency | GBP |
| Governing law / policy basis | Laws of England and Wales |
...
The buyer’s strategic intent is not to replace governance with technology; it is to make governance executable inside the technology stack. Any proposed solution must therefore support robust segregation of duties, transparent operator actions, well-defined failure handling, and integration into established risk and assurance processes. The buyer expects detailed disclosure of solution boundaries, assumptions, and third-party dependencies. Bank of England reserves the right to reject any proposal that relies on unclear roadmap commitments, unsupported legal assumptions, or immature operational models. Applicable regulatory reference points include UK FMI rules, Operational Resilience regime, UK GDPR, NCSC/NIS-aligned controls where relevant, AML/CFT controls where relevant. These references are not exhaustive and vendors remain responsible for identifying any other frameworks relevant to the proposed delivery model.

### 1.2 Procurement Objectives and Target Outcomes
The buyer is seeking a bidder or consortium capable of delivering a controlled and supportable capability for **wholesale CBDC pilot infrastructure**. The procurement objectives below are cumulative. Failure to support a mandatory objective may result in rejection.
...
| Scalable processing | Support public-policy control, critical-service resilience, policy experimentation with bounded risk, and evidence-grade auditability. | High |
| Regulatory alignment | Provide evidence aligned to UK FMI rules, Operational Resilience regime, UK GDPR, NCSC/NIS-aligned controls where relevant, AML/CFT controls where relevant. | Mandatory |
...
| Workflow configuration | Yes | Production support for wholesale CBDC pilot infrastructure processes, approvals, exceptions, and reporting |
...
| --- | --- | --- | --- | --- |
| TR-001 | P1 | Provide logically segregated environments for development, test, pre-production, and production with controlled promotion paths. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-002 | P1 | Support infrastructure-as-code, configuration baselining, and repeatable environment reconstruction. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-003 | P1 | Provide immutable audit logs for privileged actions, configuration changes, and critical operational events. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-004 | P1 | Support high-availability deployment patterns across independent failure domains with no single point of failure. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-005 | P1 | Expose comprehensive observability across application, infrastructure, message flow, and business process layers. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-006 | P2 | Support time synchronization, evidence-grade timestamping, and log correlation across distributed components. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-007 | P2 | Provide backup, restore, and disaster recovery procedures with documented recovery objectives. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-008 | P2 | Support secure API access using modern authentication and authorization standards. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-009 | P2 | Enable controlled software release management including rollback procedures and maintenance windows. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-010 | P3 | Provide formal runbooks for incident response, capacity management, and operational handover. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-011 | P3 | Support evidence-based performance testing under representative and stress conditions. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-012 | P3 | Provide operator controls for configuration freeze, emergency access, and controlled degradation modes. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-013 | P1 | Implement strong identity and access management with role separation, least privilege, and privileged access monitoring. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-014 | P1 | Provide encryption for data in transit and at rest with documented key-management controls and segregation of duties. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-015 | P1 | Support security event monitoring and integration into the institution’s SIEM and case-management tooling. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-016 | P1 | Provide vulnerability management, patch governance, software bill of materials, and dependency disclosure. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-017 | P1 | Demonstrate secure development lifecycle controls including code review, testing, and change approval gates. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-018 | P2 | Support data classification, retention, deletion, and evidencing of data-handling controls. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-019 | P2 | Provide incident notification procedures aligned to applicable regulatory timelines and institutional escalation paths. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-020 | P2 | Support network segmentation, API protection, certificate lifecycle control, and secrets management. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-021 | P2 | Provide resilience against denial-of-service, message replay, duplicate processing, and operator error. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-022 | P3 | Demonstrate third-party risk management for subcontractors, hosting providers, and critical dependencies. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-023 | P3 | Provide penetration testing evidence and remediation tracking for identified findings. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-024 | P3 | Support cryptographic agility and controlled key rotation without service disruption. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-025 | P1 | Provide a delivery plan with milestones, dependencies, resourcing assumptions, and acceptance criteria. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-026 | P1 | Identify buyer dependencies requiring timely decisions, data, access, or policy input. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-027 | P1 | Provide a migration approach for interfaces, data, participant onboarding, and operational cutover. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-028 | P1 | Support structured testing phases including unit, system, integration, performance, security, and operational readiness. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-029 | P1 | Provide training materials for operations, support, security, and business administrators. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-030 | P2 | Define service transition deliverables including runbooks, support model, and knowledge transfer evidence. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-031 | P2 | Provide governance forums, reporting cadence, issue escalation, and decision control points. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-032 | P2 | State assumptions relating to third-party connectivity, environment readiness, and institutional approvals. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-033 | P2 | Provide rollback and contingency plans for implementation failures or control exceptions. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-034 | P3 | Support parallel running and controlled coexistence with legacy processes during migration. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-035 | P3 | Provide post-go-live hypercare and measurable stabilization criteria. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-036 | P3 | Provide ongoing roadmap governance separating committed functionality from exploratory items. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
...
1. **TR-001 (P1)** — Provide logically segregated environments for development, test, pre-production, and production with controlled promotion paths.
2. **TR-002 (P1)** — Support infrastructure-as-code, configuration baselining, and repeatable environment reconstruction.
3. **TR-003 (P1)** — Provide immutable audit logs for privileged actions, configuration changes, and critical operational events.
4. **TR-004 (P1)** — Support high-availability deployment patterns across independent failure domains with no single point of failure.
5. **TR-005 (P1)** — Expose comprehensive observability across application, infrastructure, message flow, and business process layers.
6. **TR-006 (P2)** — Support time synchronization, evidence-grade timestamping, and log correlation across distributed components.
7. **TR-007 (P2)** — Provide backup, restore, and disaster recovery procedures with documented recovery objectives.
8. **TR-008 (P2)** — Support secure API access using modern authentication and authorization standards.
9. **TR-009 (P2)** — Enable controlled software release management including rollback procedures and maintenance windows.
10. **TR-010 (P3)** — Provide formal runbooks for incident response, capacity management, and operational handover.
11. **TR-011 (P3)** — Support evidence-based performance testing under representative and stress conditions.
12. **TR-012 (P3)** — Provide operator controls for configuration freeze, emergency access, and controlled degradation modes.
13. **TR-013 (P1)** — Implement strong identity and access management with role separation, least privilege, and privileged access monitoring.
14. **TR-014 (P1)** — Provide encryption for data in transit and at rest with documented key-management controls and segregation of duties.
15. **TR-015 (P1)** — Support security event monitoring and integration into the institution’s SIEM and case-management tooling.
16. **TR-016 (P1)** — Provide vulnerability management, patch governance, software bill of materials, and dependency disclosure.
17. **TR-017 (P1)** — Demonstrate secure development lifecycle controls including code review, testing, and change approval gates.
18. **TR-018 (P2)** — Support data classification, retention, deletion, and evidencing of data-handling controls.
19. **TR-019 (P2)** — Provide incident notification procedures aligned to applicable regulatory timelines and institutional escalation paths.
20. **TR-020 (P2)** — Support network segmentation, API protection, certificate lifecycle control, and secrets management.
21. **TR-021 (P2)** — Provide resilience against denial-of-service, message replay, duplicate processing, and operator error.
22. **TR-022 (P3)** — Demonstrate third-party risk management for subcontractors, hosting providers, and critical dependencies.
23. **TR-023 (P3)** — Provide penetration testing evidence and remediation tracking for identified findings.
24. **TR-024 (P3)** — Support cryptographic agility and controlled key rotation without service disruption.
25. **TR-025 (P1)** — Provide a delivery plan with milestones, dependencies, resourcing assumptions, and acceptance criteria.
26. **TR-026 (P1)** — Identify buyer dependencies requiring timely decisions, data, access, or policy input.
27. **TR-027 (P1)** — Provide a migration approach for interfaces, data, participant onboarding, and operational cutover.
28. **TR-028 (P1)** — Support structured testing phases including unit, system, integration, performance, security, and operational readiness.
29. **TR-029 (P1)** — Provide training materials for operations, support, security, and business administrators.
30. **TR-030 (P2)** — Define service transition deliverables including runbooks, support model, and knowledge transfer evidence.

## 3. Regulatory & Compliance Requirements

### 3.1 Applicable Regulatory Context
The buyer operates within United Kingdom and expects bidder responses to align with the applicable supervisory and policy environment, including engagement with Bank of England policy framework, HM Treasury coordination where relevant, and FCA interfaces where applicable. Bidders remain responsible for identifying any additional regulatory, legal, or policy constraints triggered by their proposed architecture, operating model, subcontracting chain, hosting arrangement, or data handling approach. Stating that “compliance is the buyer’s responsibility” will be treated as an inadequate answer where the bidder’s design choices create or increase regulatory exposure.

### 3.2 Regulatory Requirement Set
| ID | Control area | Requirement |
| --- | --- | --- |
| REG-001 | Applicable framework mapping | Bidders shall map the proposed solution and delivery model against UK FMI rules, Operational Resilience regime, UK GDPR, NCSC/NIS-aligned controls where relevant, AML/CFT controls where relevant and identify any jurisdiction-specific limitations or dependencies. |
...
Bank of England expects bidders to anchor their response in the buyer's actual strategic posture rather than reuse a generic tokenization template. The Bank of England has publicly explored wholesale CBDC, synchronized settlement and tokenized money / securities interaction through multiple discussion papers and experiments. A realistic procurement document should therefore read like an infrastructure-grade market soundings document for highly controlled, systemic workflows. In practical terms, that means the proposed platform must support institutional-grade digital-asset issuance, servicing, settlement, reporting and control workflows while fitting into RTGS, settlement infrastructure, participant access controls, supervisory reporting, resilience testing, cyber assurance and FMI governance. The bank or fintech will not score a response well if the digital-asset layer becomes a sidecar disconnected from existing books and records, operations controls, treasury workflows, or regulator-facing reporting.

The issuing team also expects bidders to recognize the buyer's governance model. financial-market-infrastructure, technology, payments, policy, security and procurement leadership. This has two consequences. First, proposals must explain how the platform supports board-level oversight, architecture review, risk sign-off and third-party control testing before production launch. Second, vendors must show how implementation can proceed without creating a long tail of manual exceptions that move risk into operations rather than remove it.

From a procurement standpoint, The Bank will emphasize systemic resilience, neutral market design, interoperability and evidence-backed delivery claims. Proposals should therefore describe not just target-state functionality but also the migration path from current-state processes, including coexistence with legacy systems, phased onboarding of products or jurisdictions, and rollback or containment measures if external dependencies fail.

### Regulatory and Jurisdictional Context
The regulatory perimeter for this procurement is shaped by Bank of England policy and supervisory framework, HM Treasury policy context, FMI and systemic-risk expectations, UK data and resilience requirements. Where the proposed operating model involves crypto-asset issuance, trading, custody, settlement or payment functionality in the EEA, respondents must explain how MiCA obligations are allocated across the buyer, the platform provider and any custody, exchange, wallet, payment or reserve-management partners. The buyer does not want hand-waving about regulatory coverage; it wants a control map that identifies which legal and operational obligations remain with the institution and which are facilitated by the proposed platform.
...
The solution must interoperate cleanly with the buyer's established control estate. That includes RTGS, settlement infrastructure, participant access controls, supervisory reporting, resilience testing, cyber assurance and FMI governance. Vendors should describe canonical data models, API contracts, event-taxonomy design, idempotency controls, batch and streaming interfaces, and how reconciliation breaks are surfaced and resolved. If the proposed platform maintains its own ledger, respondents must explain how golden-source boundaries are defined and how downstream finance, risk and regulatory systems consume authoritative records.
