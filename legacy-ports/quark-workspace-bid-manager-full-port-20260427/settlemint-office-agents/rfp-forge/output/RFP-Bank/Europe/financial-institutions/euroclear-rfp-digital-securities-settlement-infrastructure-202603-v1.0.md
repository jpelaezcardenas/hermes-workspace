# Request for Proposal (RFP): Digital Securities Settlement Infrastructure

| Field | Value |
| --- | --- |
| Reference number | EUROCLEAR-RFP-202603 |
| Version | v1.0 |
| Issue date | March 2026 |
| Issuing institution | Euroclear |
| Jurisdiction | Belgium |
| Currency | EUR |
| Governing law / policy basis | Belgian law |
...
The buyer’s strategic intent is not to replace governance with technology; it is to make governance executable inside the technology stack. Any proposed solution must therefore support robust segregation of duties, transparent operator actions, well-defined failure handling, and integration into established risk and assurance processes. The buyer expects detailed disclosure of solution boundaries, assumptions, and third-party dependencies. Euroclear reserves the right to reject any proposal that relies on unclear roadmap commitments, unsupported legal assumptions, or immature operational models. Applicable regulatory reference points include CSDR, DORA, MiCA where applicable, GDPR, AMLD, NIS2, EMIR interfaces where relevant. These references are not exhaustive and vendors remain responsible for identifying any other frameworks relevant to the proposed delivery model.

### 1.2 Procurement Objectives and Target Outcomes
The buyer is seeking a bidder or consortium capable of delivering a controlled and supportable capability for **digital securities settlement infrastructure**. The procurement objectives below are cumulative. Failure to support a mandatory objective may result in rejection.
...
| Scalable processing | Support finality, resiliency, interoperability with custody and collateral ecosystems, and high-integrity post-trade control. | High |
| Regulatory alignment | Provide evidence aligned to CSDR, DORA, MiCA where applicable, GDPR, AMLD, NIS2, EMIR interfaces where relevant. | Mandatory |
...
| Workflow configuration | Yes | Production support for digital securities settlement infrastructure processes, approvals, exceptions, and reporting |
...
| --- | --- | --- | --- | --- |
| TR-001 | P1 | Support atomic or tightly controlled delivery-versus-payment workflow orchestration with explicit exception handling. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-002 | P1 | Provide finality-state management, reconciliation controls, and end-of-day evidence outputs. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-003 | P1 | Support participant messaging, queue management, and settlement prioritization rules. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-004 | P1 | Provide integration options for cash leg coordination, liquidity checks, and settlement instruction enrichment. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-005 | P1 | Support corporate-action, entitlement, and lifecycle-event propagation where applicable. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-006 | P2 | Provide bilateral and multilateral reconciliation across participant, operator, and ledger views. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-007 | P2 | Support cut-off management, daylight saving control, and jurisdiction-specific calendar handling. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-008 | P2 | Provide failover procedures that preserve message integrity and duplicate prevention. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-009 | P2 | Support intraday monitoring of pending, matched, failed, recycled, and settled instructions. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-010 | P3 | Provide configurable tolerance rules, break management, and exception evidence packages. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
...
1. **TR-001 (P1)** — Support atomic or tightly controlled delivery-versus-payment workflow orchestration with explicit exception handling.
2. **TR-002 (P1)** — Provide finality-state management, reconciliation controls, and end-of-day evidence outputs.
3. **TR-003 (P1)** — Support participant messaging, queue management, and settlement prioritization rules.
4. **TR-004 (P1)** — Provide integration options for cash leg coordination, liquidity checks, and settlement instruction enrichment.
5. **TR-005 (P1)** — Support corporate-action, entitlement, and lifecycle-event propagation where applicable.
6. **TR-006 (P2)** — Provide bilateral and multilateral reconciliation across participant, operator, and ledger views.
7. **TR-007 (P2)** — Support cut-off management, daylight saving control, and jurisdiction-specific calendar handling.
8. **TR-008 (P2)** — Provide failover procedures that preserve message integrity and duplicate prevention.
9. **TR-009 (P2)** — Support intraday monitoring of pending, matched, failed, recycled, and settled instructions.
10. **TR-010 (P3)** — Provide configurable tolerance rules, break management, and exception evidence packages.
...
The buyer operates within Belgium and expects bidder responses to align with the applicable supervisory and policy environment, including engagement with National Bank of Belgium, FSMA, European Central Bank oversight where applicable, and relevant EU supervisory authorities. Bidders remain responsible for identifying any additional regulatory, legal, or policy constraints triggered by their proposed architecture, operating model, subcontracting chain, hosting arrangement, or data handling approach. Stating that “compliance is the buyer’s responsibility” will be treated as an inadequate answer where the bidder’s design choices create or increase regulatory exposure.

### 3.2 Regulatory Requirement Set
| ID | Control area | Requirement |
| --- | --- | --- |
| REG-001 | Applicable framework mapping | Bidders shall map the proposed solution and delivery model against CSDR, DORA, MiCA where applicable, GDPR, AMLD, NIS2, EMIR interfaces where relevant and identify any jurisdiction-specific limitations or dependencies. |
