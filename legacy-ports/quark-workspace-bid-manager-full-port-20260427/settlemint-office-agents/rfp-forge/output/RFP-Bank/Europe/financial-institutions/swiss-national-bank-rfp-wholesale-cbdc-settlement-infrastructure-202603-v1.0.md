# Request for Proposal (RFP): Wholesale Cbdc Settlement Infrastructure

| Field | Value |
| --- | --- |
| Reference number | SWISSNATIONALBANK-RFP-202603 |
| Version | v1.0 |
| Issue date | March 2026 |
| Issuing institution | Swiss National Bank |
| Jurisdiction | Switzerland |
| Currency | CHF |
| Governing law / policy basis | Swiss law |
...
The buyer’s strategic intent is not to replace governance with technology; it is to make governance executable inside the technology stack. Any proposed solution must therefore support robust segregation of duties, transparent operator actions, well-defined failure handling, and integration into established risk and assurance processes. The buyer expects detailed disclosure of solution boundaries, assumptions, and third-party dependencies. Swiss National Bank reserves the right to reject any proposal that relies on unclear roadmap commitments, unsupported legal assumptions, or immature operational models. Applicable regulatory reference points include National Bank Act, FMIA, Swiss Data Protection Act, AMLA where relevant, CPMI-IOSCO PFMI and BIS-aligned control expectations. These references are not exhaustive and vendors remain responsible for identifying any other frameworks relevant to the proposed delivery model.

### 1.2 Procurement Objectives and Target Outcomes
The buyer is seeking a bidder or consortium capable of delivering a controlled and supportable capability for **wholesale CBDC settlement infrastructure**. The procurement objectives below are cumulative. Failure to support a mandatory objective may result in rejection.
...
| Scalable processing | Support sovereign-grade resiliency, legal certainty, monetary control, privacy proportionality, and operational assurance for critical infrastructure. | High |
| Regulatory alignment | Provide evidence aligned to National Bank Act, FMIA, Swiss Data Protection Act, AMLA where relevant, CPMI-IOSCO PFMI and BIS-aligned control expectations. | Mandatory |
...
| Workflow configuration | Yes | Production support for wholesale CBDC settlement infrastructure processes, approvals, exceptions, and reporting |
...
The buyer operates within Switzerland and expects bidder responses to align with the applicable supervisory and policy environment, including engagement with Swiss National Bank policy framework, FINMA coordination where relevant, and federal legal constraints. Bidders remain responsible for identifying any additional regulatory, legal, or policy constraints triggered by their proposed architecture, operating model, subcontracting chain, hosting arrangement, or data handling approach. Stating that “compliance is the buyer’s responsibility” will be treated as an inadequate answer where the bidder’s design choices create or increase regulatory exposure.

### 3.2 Regulatory Requirement Set
| ID | Control area | Requirement |
| --- | --- | --- |
| REG-001 | Applicable framework mapping | Bidders shall map the proposed solution and delivery model against National Bank Act, FMIA, Swiss Data Protection Act, AMLA where relevant, CPMI-IOSCO PFMI and BIS-aligned control expectations and identify any jurisdiction-specific limitations or dependencies. |
