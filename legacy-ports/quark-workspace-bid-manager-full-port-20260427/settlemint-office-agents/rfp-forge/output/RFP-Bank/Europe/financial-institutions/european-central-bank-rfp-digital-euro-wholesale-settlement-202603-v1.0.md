# Request for Proposal (RFP): Digital Euro Wholesale Settlement

| Field | Value |
| --- | --- |
| Reference number | EUROPEANCENTRALBANK-RFP-202603 |
| Version | v1.0 |
| Issue date | March 2026 |
| Issuing institution | European Central Bank |
| Jurisdiction | European Union |
| Currency | EUR |
| Governing law / policy basis | Applicable EU law and ECB legal instruments |
...
The buyer is seeking a bidder or consortium capable of delivering a controlled and supportable capability for **digital euro wholesale settlement**. The procurement objectives below are cumulative. Failure to support a mandatory objective may result in rejection.
...
| Scalable processing | Support Eurosystem interoperability, settlement finality, jurisdictional consistency, supervisory transparency, and systemic resilience. | High |
| Regulatory alignment | Provide evidence aligned to T2/T2S policy alignment, DORA, GDPR, NIS2, AML/CFT framework where relevant, CPMI-IOSCO PFMI, EU data and outsourcing requirements. | Mandatory |
...
| Workflow configuration | Yes | Production support for digital euro wholesale settlement processes, approvals, exceptions, and reporting |
...
| TR-011 | P3 | Support policy-controlled issuance, redemption, transfer, and restricted circulation workflows for wholesale money. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-012 | P3 | Provide central bank operator controls for participant admission, transaction rules, and emergency suspension. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-013 | P1 | Support privacy-by-design consistent with wholesale supervisory requirements and evidentiary access needs. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-014 | P1 | Provide interoperability patterns with RTGS, securities settlement, and liquidity management environments. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-015 | P1 | Support programmable control boundaries without undermining legal certainty or operator oversight. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-016 | P1 | Provide ledger governance features for controlled upgrade, validation, and incident intervention. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-017 | P1 | Support offline simulation, controlled test environments, and policy scenario experimentation. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-018 | P2 | Provide strong key and certificate governance appropriate for sovereign or quasi-sovereign infrastructures. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-019 | P2 | Support observability and reporting for monetary operations, participant concentration, and systemic events. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
| TR-020 | P2 | Provide legal-record export and evidentiary support for audit, oversight, and policy review. | Detailed narrative, architecture diagram, control description, and client reference evidence | Comply / Partially comply / Does not comply |
...
11. **TR-011 (P3)** — Support policy-controlled issuance, redemption, transfer, and restricted circulation workflows for wholesale money.
12. **TR-012 (P3)** — Provide central bank operator controls for participant admission, transaction rules, and emergency suspension.
13. **TR-013 (P1)** — Support privacy-by-design consistent with wholesale supervisory requirements and evidentiary access needs.
14. **TR-014 (P1)** — Provide interoperability patterns with RTGS, securities settlement, and liquidity management environments.
15. **TR-015 (P1)** — Support programmable control boundaries without undermining legal certainty or operator oversight.
16. **TR-016 (P1)** — Provide ledger governance features for controlled upgrade, validation, and incident intervention.
17. **TR-017 (P1)** — Support offline simulation, controlled test environments, and policy scenario experimentation.
18. **TR-018 (P2)** — Provide strong key and certificate governance appropriate for sovereign or quasi-sovereign infrastructures.
19. **TR-019 (P2)** — Support observability and reporting for monetary operations, participant concentration, and systemic events.
20. **TR-020 (P2)** — Provide legal-record export and evidentiary support for audit, oversight, and policy review.
