...
date: 2026-03-14
version: v1.0
reference: ING-2026-001
---

# Request for Proposal: Tokenized Trade Finance Platform
...
This RFP concerns tokenized trade finance as the primary asset class. The Bank is seeking binding proposals for an implementation-capable platform. The in-scope scenarios include Digitally represented receivables, transferable trade documents and financing workflows supporting issuance, endorsement/transfer, collateral visibility, maturity events and exception handling.
