...
document-type: rfp
asset-class: digital securities
date: 2026-03-14
version: v1.0
reference: BARC-2026-001
---

# Request for Proposal: Digital Securities Issuance and Servicing Platform
...
This RFP concerns digital securities as the primary asset class. The Bank is seeking binding proposals for an implementation-capable platform. The in-scope scenarios include Wholesale debt and selected structured security workflows requiring issuance setup, allocation, settlement coordination, investor recordkeeping, event processing and reporting.
...
Barclays Bank PLC expects bidders to anchor their response in the buyer's actual strategic posture rather than reuse a generic tokenization template. Barclays has explored digital assets through institutional market infrastructure partnerships, digital collateral and repo workflow modernization, and broader tokenized securities discussions within its investment banking and markets franchise. Public evidence is less about retail crypto and more about institutional workflows, post-trade efficiency, collateral mobility and digitally native capital markets issuance. In practical terms, that means the proposed platform must support digitally native issuance, investor allocation, settlement coordination, paying-agent workflows, lifecycle servicing and secondary-market controls while fitting into existing investment banking booking systems, collateral management platforms, treasury and liquidity tooling, SWIFT messaging, securities operations platforms, finance ledgers, identity and access management, and enterprise observability controls. The bank or fintech will not score a response well if the digital-asset layer becomes a sidecar disconnected from existing books and records, operations controls, treasury workflows, or regulator-facing reporting.
...
For this procurement, bidders should assume that the first live use cases will be concrete rather than experimental. At minimum, the target operating model should support digitally native issuance, investor allocation, settlement coordination, paying-agent workflows, lifecycle servicing and secondary-market controls. The proposed platform should show how configuration, approvals, ledger updates, settlement instructions, exception handling and reporting are orchestrated across those use cases without requiring brittle one-off customization for each product or jurisdiction.
