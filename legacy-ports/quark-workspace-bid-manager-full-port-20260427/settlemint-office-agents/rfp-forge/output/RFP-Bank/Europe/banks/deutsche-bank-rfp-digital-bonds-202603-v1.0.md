...
# Deutsche Bank — Request for Proposal
## Digital Bonds Platform

| Field | Value |
|-------|-------|
| **Document Reference** | DB-RFP-202603-01 |
| **Version** | v1.0 |
| **Issue Date** | March 2026 |
| **Submission Deadline** | May 2026 |
| **Classification** | Confidential |
| **Issuing Entity** | Deutsche Bank AG |
...
- Industrialise euro-denominated digital bond issuance across private and public issuance models.
- Connect issuance workflows to existing treasury, custody, AML, and reporting stacks.
- Reduce settlement latency while preserving investor protection, record integrity, and regulated governance.

The target operating model must support both native digital securities issuance and mirrored registry operation where required by product governance or investor preference. The buyer expects vendors to respond in a disciplined, evidence-backed manner and to distinguish clearly between delivered functionality, configurable functionality, partner-enabled capability, and roadmap items.
...
The governing regulatory context includes MiCA, MiFID II, CSDR, German Electronic Securities Act (eWpG), DORA, GDPR, BaFin guidance on crypto securities and custody. Vendors remain responsible for identifying any additional regulatory dependencies relevant to their proposed architecture, hosting model, and service delivery structure.
...
The buyer requires proposals that are workable within the German and EU regulatory perimeter. Responses shall explain how the proposed platform supports a regulated financial institution operating under MiCA, MiFID II, CSDR, German Electronic Securities Act (eWpG), DORA, GDPR, BaFin guidance on crypto securities and custody. The response must distinguish between obligations addressed by product design, obligations addressed through buyer policy or operating procedure, and obligations dependent on third-party service providers.
