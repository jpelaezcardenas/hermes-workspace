...
date: 2026-03-14
version: v1.0
reference: SG-2026-001
---

# Request for Proposal: Enterprise Platform for Digital Bond Issuance and Servicing
...
This RFP focuses on a production-grade platform for digital bond issuance and post-issuance servicing, with a design that can later extend to covered bonds, structured notes and selected wholesale debt instruments. In scope are issuance workflow orchestration, investor onboarding integration, book-building data exchange, allocation support, token minting controls, registry maintenance, coupon and redemption processing, transfer restrictions, corporate action workflows, reconciliations, and regulatory reporting support.
