...
| TR-002 | P1 | Configurable market models, trading sessions, venue state | Partial | DALP provides token/compliance state controls; D3X provides order book/market model |
