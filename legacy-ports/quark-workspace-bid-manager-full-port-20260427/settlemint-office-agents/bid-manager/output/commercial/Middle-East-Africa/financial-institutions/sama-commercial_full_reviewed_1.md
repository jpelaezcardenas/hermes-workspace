...
For sovereign programmes, liability terms are subject to negotiation. SettleMint's default liability cap of 12 months of licence fees will be discussed with SAMA's legal team. SAMA, as a sovereign regulatory authority, may request alternative cap structures. SettleMint is open to structuring liability terms that reflect the programme's sovereign nature while maintaining proportionality to the annual contract value. Standard exclusions apply for indirect/consequential losses.

**Multi-year discount structuring note:** The 10% committed-term discount ($216,000 total saving over 3 years) can be structured as: (a) Year 1 payment credit if SAMA prefers to retain annual renewal flexibility while locking pricing; or (b) upfront commitment discount applied at contract signing. SAMA's procurement team should indicate the preferred structure during commercial negotiation.
