...
- **Currency:** USD or EUR equivalent at contract signing. EUR pricing applies to platform licence and support fees. Infrastructure costs are billed by the cloud provider (OVHcloud/Azure) in EUR directly to CSE's cloud account.
