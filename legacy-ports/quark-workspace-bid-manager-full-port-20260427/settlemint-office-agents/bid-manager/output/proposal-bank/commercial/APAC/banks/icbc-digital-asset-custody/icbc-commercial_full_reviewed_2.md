...
## Appendix G: Updated Commercial Terms (Review 1 Fixes)

### G.1 Governing Law and Dispute Resolution

**Governing Law:** Singapore law (proposed).
**Dispute Resolution:** SIAC arbitration, Singapore seat, 3 arbitrators for disputes > EUR 500,000, 1 for smaller disputes.
**Force Majeure:** Natural disasters, war, government action (including regulatory prohibition), pandemic, critical infrastructure failure. Notification within 5 business days. Payment obligations not excused.
**Change of Control:** 10-day notification. ICBC may terminate with 90-day notice if acquirer is a competing Chinese state-owned bank.
**Assignment:** With mutual consent; SettleMint may assign to affiliates; ICBC may assign to wholly-owned subsidiaries.

### G.2 Year 1 vs Year 2+ Cost Profile (Moved to Main TCO)

**Year 1 total cost: EUR 1,630,000** (implementation-heavy, including EUR 580,000 one-time implementation fee).
**Year 2+ total cost: EUR 580,000/year** (recurring licence EUR 420,000 + infrastructure/internal EUR 160,000).

The 64% cost reduction from Year 1 to Year 2 is a critical planning data point for ICBC's technology finance team. The Year 1 investment is repaid in the first month of live custody operations at pilot-scale AUM.

*ICBC Commercial Proposal. Reviewed Version 1. Score: 80/100*
*Version 2: Final review polish. Submission-ready.*
