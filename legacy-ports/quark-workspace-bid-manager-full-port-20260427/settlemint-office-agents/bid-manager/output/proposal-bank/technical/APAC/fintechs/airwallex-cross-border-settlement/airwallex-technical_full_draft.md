...
| Institution Type | Region | Use Case | Scale |
|---|---|---|---|
| Central Bank | Middle East | CBDC pilot infrastructure; wholesale settlement | Multi-jurisdictional |
| Commercial Bank | Europe | Tokenized bond issuance and servicing | Institutional |
| Market Infrastructure | Europe | Digital securities settlement | Exchange-scale |
| Large Fintech | APAC | Cross-border payment settlement | High-volume |
